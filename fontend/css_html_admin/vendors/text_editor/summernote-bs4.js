(function (global, factory) {
    ...
    var TooltipUI = (function () {
        ...
        TooltipUI.prototype.show = function () {
            ...
            if (placement === 'bottom') {
                $tooltip.css({top: offset.top + nodeHeight, left: offset.left + (nodeWidth / 2 - tooltipWidth / 2)});
            } else if (placement === 'top') {
                $tooltip.css({top: offset.top - tooltipHeight, left: offset.left + (nodeWidth / 2 - tooltipWidth / 2)});
                ...
                $tooltip.css({top: offset.top + (nodeHeight / 2 - tooltipHeight / 2), left: offset.left + nodeWidth});
            }
        };
    ...
    var DropdownUI = (function () {
        function DropdownUI($node, options) {
            this.$button = $node;
            this.options = $.extend({}, {target: options.container}, options);
            this.setEvent();
        }
    ...
    var ModalUI = (function () {
        function ModalUI($node, options) {
            this.options = $.extend({}, {target: options.container || 'body'}, options);
            this.$modal = $node;
    ...
    var button = renderer.create('<button type="button" class="note-btn" role="button" tabindex="-1">', function ($node, options) {
        if (options && options.tooltip) {
            $node.attr({'aria-label': options.tooltip});
        ...
        if (options && options.data && options.data.toggle === 'dropdown') {
            $node.data('_lite_dropdown', new DropdownUI($node, {container: options.container}));
        }
    });
    ...
    var paragraphDropdownButton = function (opt) {
        ...
        }), buttonGroup({className: 'note-list', children: opt.items[1]}),]),]).render();
    };
    ...
    var palette = renderer.create('<div class="note-color-palette"/>', function ($node, options) {
        ...
        $node.find('.note-color-btn').each(function () {
            $(this).data('_lite_tooltip', new TooltipUI($(this), {container: options.container}));
        });
    });
            ...
            children: [button({
                ...
                callback: function ($dropdown) {
                    $dropdown.find('.note-holder').each(function () {
                        var $holder = $(this);
                        $holder.append(palette({colors: opt.colors, eventName: $holder.data('event')}).render());
                    });
                    if (type === 'fore') {
    ...
    var videoDialog = function (opt) {
        ...
        return dialog({title: opt.lang.video.insert, fade: opt.fade, body: body, footer: footer}).render();
    };
    var imageDialog = function (opt) {
        ...
        return dialog({title: opt.lang.image.insert, fade: opt.fade, body: body, footer: footer}).render();
    };
    ...
    var WrappedRange = (function () {
        ...
        WrappedRange.prototype.nativeRange = function () {
            if (env.isW3CRangeSupport) {
                ...
                textRange.setEndPoint('EndToEnd', pointToTextRange({node: this.ec, offset: this.eo}));
                return textRange;
            }
        };
        ...
        WrappedRange.prototype.paraBookmark = function (paras) {
            return {
                s: {path: lists.tail(dom.makeOffsetPath(lists.head(paras), this.sc)), offset: this.so},
                e: {path: lists.tail(dom.makeOffsetPath(lists.last(paras), this.ec)), offset: this.eo}
            };
        };
    ...
    var Style = (function () {
        ...
        Style.prototype.stylePara = function (rng, styleInfo) {
            $$1.each(rng.nodes(dom.isPara, {includeAncestor: true}), function (idx, para) {
    ...
    var Editor = (function () {
        function Editor(context) {
            ...
            this.lineHeight = this.wrapCommand(function (value) {
                _this.style.stylePara(_this.getLastRange(), {lineHeight: value});
            });
    ...
    var Fullscreen = (function () {
        function Fullscreen(context) {
            ...
            this.onResize = function () {
                _this.resizeTo({h: _this.$window.height() - _this.$toolbar.outerHeight()});
            };
        }
    ...
    var Handle = (function () {
        ...
        Handle.prototype.update = function (target, event) {
            ...
            if (isImage) {
                ...
                var imageSize = {w: $image.outerWidth(false), h: $image.outerHeight(false)};
                $selection.css({
                    display: 'block',
                    left: pos.left,
                    top: pos.top,
    ...
    var Buttons = (function () {
        ...
        Buttons.prototype.colorPalette = function (className, tooltip, backColor, foreColor) {
            ...
            return this.ui.buttonGroup({
                className: 'note-color ' + className, children: [this.button({
                    className: 'note-current-color-button',
                    ...
                    click: function (e) {
                        ...
                        if (backColor && foreColor) {
                            ...
                            _this.context.invoke('editor.color', {backColor: $button.attr('data-backColor')});
                        } else if (foreColor) {
                            _this.context.invoke('editor.color', {foreColor: $button.attr('data-foreColor')});
                        }
                    },
                    callback: function ($button) {
                        var $recentColor = $button.find('.note-recent-color');
        ...
        Buttons.prototype.addToolbarButtons = function () {
            ...
            this.context.memo('button.paragraph', function () {
                ...
                }), _this.ui.buttonGroup({className: 'note-list', children: [outdent, indent]}),]),]).render();
            });
        ...
        Buttons.prototype.build = function ($container, groups) {
            for (var groupIdx = 0, groupLen = groups.length; groupIdx < groupLen; groupIdx++) {
                ...
                var $group = this.ui.buttonGroup({className: 'note-' + groupName}).render();
    ...
    var Toolbar = (function () {
        ...
        Toolbar.prototype.followScroll = function () {
            ...
            if (!this.isFollowing && (currentOffset > activateOffset) && (currentOffset < deactivateOffsetBottom - toolbarHeight)) {
                ...
                this.$toolbar.css({position: 'fixed', top: otherBarHeight, width: editorWidth});
    ...
    var HelpDialog = (function () {
        ...
        HelpDialog.prototype.initialize = function () {
            ...
            this.$dialog = this.ui.dialog({
                ...
                footer: body,
                callback: function ($node) {
                    $node.find('.modal-body,.note-modal-body').css({'max-height': 300, 'overflow': 'scroll'});
                }
            }).render().appendTo($container);
        };
    ...
    $$1.summernote = $$1.extend($$1.summernote, {
        version: '0.8.12', plugins: {}, dom: dom, range: range, options: {
    ...
    $$1.summernote = $$1.extend($$1.summernote, {ui: ui});
}));