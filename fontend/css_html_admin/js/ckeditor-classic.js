...
!function (t) {
    ...
    return function (t) {
        ...
        "use strict";
        (function (t) {
            var i = n(3), o = n(11), r = "object" == typeof exports && exports && !exports.nodeType && exports,
        ...
        "use strict";
        n.r(e);
        var i = n(3), o = i.a.Symbol, r = Object.prototype, s = r.hasOwnProperty, a = r.toString,
        ...
        var h = function (t) {
            return d.call(t)
        }, u = "[object Null]", f = "[object Undefined]", m = o ? o.toStringTag : void 0;
        var g = function (t) {
        ...
        bt.prototype.clear = ct, bt.prototype.delete = lt, bt.prototype.get = ut, bt.prototype.has = mt, bt.prototype.set = pt;
        var wt = bt;
        var kt = function () {
        ...
        Et.prototype.clear = L, Et.prototype.delete = j, Et.prototype.get = V, Et.prototype.has = z, Et.prototype.set = Mt;
        var It = Et;
        var Nt = function (t, e) {
        ...
        var Bt = function (t) {
            return w(t) && g(t) == zt
        }, Ft = Object.prototype, Ut = Ft.hasOwnProperty, Ht = Ft.propertyIsEnumerable, qt = Bt(function () {
            return arguments
        }()) ? Bt : function (t) {
            return w(t) && Ut.call(t, "callee") && !Ht.call(t, "callee")
        }, Wt = Array.isArray, Yt = n(5), $t = 9007199254740991, Gt = /^(?:0|[1-9]\d*)$/;
        var Qt = function (t, e) {
            var n = typeof t;
        ...
        }, ee = n(4), ne = ee.a && ee.a.isTypedArray, ie = ne ? te(ne) : Xt, oe = Object.prototype.hasOwnProperty;
        var re = function (t, e) {
        ...
        var Ne = function (t) {
                return Ee(t, be, Se)
            }, Oe = rt(i.a, "DataView"), Re = rt(i.a, "Promise"), De = rt(i.a, "Set"), Le = rt(i.a, "WeakMap"), je = K(Oe),
            Ve = K(st), ze = K(Re), Be = K(De), Fe = K(Le), Ue = g;
        (Oe && "[object DataView]" != Ue(new Oe(new ArrayBuffer(1))) || st && "[object Map]" != Ue(new st) || Re && "[object Promise]" != Ue(Re.resolve()) || De && "[object Set]" != Ue(new De) || Le && "[object WeakMap]" != Ue(new Le)) && (Ue = function (t) {
            var e = g(t), n = "[object Object]" == e ? t.constructor : void 0, i = n ? K(n) : "";
            if (i) switch (i) {
                case je:
        ...
        var tn = function (t, e) {
            ...
            dn = "[object ArrayBuffer]", hn = "[object DataView]", un = "[object Float32Array]",
            fn = "[object Float64Array]", mn = "[object Int8Array]", gn = "[object Int16Array]",
            pn = "[object Int32Array]", bn = "[object Uint8Array]", wn = "[object Uint8ClampedArray]",
            kn = "[object Uint16Array]", _n = "[object Uint32Array]";
        ...
        var Cn = function (t) {
            return w(t) && He(t) == Tn
        }, Pn = ee.a && ee.a.isMap, Sn = Pn ? te(Pn) : Cn, Mn = "[object Set]";
        var En = function (t) {
                return w(t) && He(t) == Mn
            }, In = ee.a && ee.a.isSet, Nn = In ? te(In) : En, On = 1, Rn = 2, Dn = 4, Ln = "[object Arguments]",
            jn = "[object Function]", Vn = "[object GeneratorFunction]", zn = "[object Object]", Bn = {};
        ...
        var Fn = function t(e, n, i, o, r, s) {
            ...
            var m = s.get(e);
            if (m) return m;
            s.set(e, a), Nn(e) ? e.forEach(function (o) {
                a.add(t(o, n, i, o, e, s))
            }) : Sn(e) && e.forEach(function (o, r) {
                a.set(r, t(o, n, i, r, e, s))
            });
            var g = d ? l ? Ne : Ie : l ? keysIn : ue, p = h ? void 0 : g(e);
        ...
        var ei = {
            on(t, e, n = {}) {
                ...
                const n = t instanceof Kn ? t : new Kn(this, t), i = n.name;
        ...
        class ki extends ui {
            constructor(t, e, n) {
                ...
                this._styles = new Map, this._attrs.has("style") && (_i(this._styles, this._attrs.get("style")), this._attrs.delete("style")), this._customProperties = new Map
            }
        ...
        var Pi = function (t, e, n) {
            return e = Ci(void 0 === e ? t.length - 1 : e, 0), function () {
        ...
        const ji = Symbol("observableProperties"), Vi = Symbol("boundObservables"), zi = Symbol("boundProperties"),
            Bi = {
                set(t, e) {
                    ...
                    const e = this[zi];
                    t.forEach(t => {
                        if (e.has(t)) throw new Gn.b("observable-bind-rebind: Cannot bind the same property more that once.", this)
                    });
                    const n = new Map;
                    return t.forEach(t => {
        ...
        function Ui(t) {
            ji in t || (Object.defineProperty(t, ji, {value: new Map}), Object.defineProperty(t, Vi, {value: new Map}), Object.defineProperty(t, zi, {value: new Map}))
        }
        ...
        function Hi(...t) {
            ...
            e.to.forEach(t => {
                if (t.properties.length && t.properties.length !== i) throw new Gn.b("observable-bind-to-properties-length: The number of properties must match.", this);
        ...
        class Ji {
            constructor(t = {}) {
                ...
                if (t.direction && "forward" != t.direction && "backward" != t.direction) throw new Gn.b("view-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.", t.startPosition, {direction: t.direction});
        ...
        class Zi {
            ...
            static _createAt(t, e) {
                if (t instanceof Zi) return new this(t.parent, t.offset);
                {
                    ...
                    if ("end" == e) e = n.is("text") ? n.data.length : n.childCount; else {
                        ...
                        if (0 !== e && !e) throw new Gn.b("view-createPositionAt-offset-required: View#createPositionAt() requires the offset when the first parameter is a view item.", n)
                    }
                    return new Zi(n, e)
                }
            }
            ...
            static _createAfter(t) {
                ...
                if (!t.parent) throw new Gn.b("view-position-after-root: You can not make position after root.", t, {root: t});
                return new Zi(t.parent, t.index + 1)
            }

            static _createBefore(t) {
                if (t.is("textProxy")) return new Zi(t.textNode, t.offsetInText);
                if (!t.parent) throw new Gn.b("view-position-before-root: You can not make position before root.", t, {root: t});
        ...
        class no {
            ...
            * getRanges() {
            ...
            _pushRange(t) {
                for (const e of this._ranges) if (t.isIntersecting(e)) throw new Gn.b("view-selection-range-intersects: Trying to add a range that intersects with another range from selection.", this, {
                    addedRange: t,
                    intersectingRange: e
                });
        ...
        const go = {"⌘": "ctrl", "⇧": "shift", "⌥": "alt"}, po = {ctrl: "⌘", shift: "⇧", alt: "⌥"}, bo = function () {
            const t = {
                arrowleft: 37,
                arrowup: 38,
                arrowright: 39,
        ...
        function Qo(t, e, n) {
            ...
            function u(i) {
                const o = (void 0 !== h[i - 1] ? h[i - 1] : -1) + 1, l = void 0 !== h[i + 1] ? h[i + 1] : -1,
                    u = o > l ? -1 : 1;
        ...
        var yr = function (t, e, n, i, o, r) {
            var s = n & _r, a = t.length, c = e.length;
            if (a != c && !(s && c > a)) return !1;
            var l = r.get(t);
            if (l && r.get(e)) return l == e;
            var d = -1, h = !0, u = n & vr ? new br : void 0;
        ...
        var Ar = function (t) {
            ...
            }, Tr = 1, Cr = 2, Pr = "[object Boolean]", Sr = "[object Date]", Mr = "[object Error]", Er = "[object Map]",
            ...
            Vr = o ? o.prototype : void 0, zr = Vr ? Vr.valueOf : void 0;
        ...
        var Qr = function (t, e, n, i, o, r) {
            ...
            if (!(n & qr)) {
                var f = d && Gr.call(t, "__wrapped__"), m = h && Gr.call(e, "__wrapped__");
                if (f || m) {
        ...
        class Zr extends ur {
            ...
            _onMutations(t) {
                ...
                for (const t of i) {
                    ...
                    Jr(i, r, a) || (this.renderer.markToSync("children", t), o.push({
                        type: "children",
                        oldChildren: i,
                        newChildren: r,
                        node: t
        ...
        }, us = "Expected a function", fs = Math.max, ms = Math.min;
        var gs = function (t, e, n) {
            var i, o, r, s, a, c, l = 0, d = !1, h = !1, u = !0;
            ...
            return e = hs(e) || 0, B(n) && (d = !!n.leading, r = (h = "maxWait" in n) ? fs(hs(n.maxWait) || 0, e) : r, u = "trailing" in n ? !!n.trailing : u), b.cancel = function () {
        ...
        class As {
            constructor(t) {
                ...
                if (Object.defineProperty(this, "_source", {
                    ...
                    writable: !0,
                    enumerable: !1
                }), Wn(t) || e) Ts(this, e ? As.getDomRangeRects(t)[0] : t.getBoundingClientRect()); else if (cr(t)) {
        ...
        function Ss(t, e, n) {
            ...
            if (![o, i].every(t => r.contains(t))) {
                ...
                Is(o, r) ? a -= r.top - e.top + n : Es(i, r) && (a += e.bottom - r.bottom + n), Ns(e, r) ? s -= r.left - e.left + n : Os(e, r) && (s += e.right - r.right + n), t.scrollTo(s, a)
            }
        }
        ...
        function Ms(t, e) {
            const n = Rs(t);
            let i, o;
            for (; t != n.document.body;) o = e(), (i = new As(t).excludeScrollbarsAndBorders()).contains(o) || (Is(o, i) ? t.scrollTop -= i.top - o.top : Es(o, i) && (t.scrollTop += o.bottom - i.bottom), Ns(o, i) ? t.scrollLeft -= i.left - o.left : Os(o, i) && (t.scrollLeft += o.right - i.right)), t = t.parentNode
        }
        ...
        class Us {
            ...
            _insertNodes(t, e) {
                for (const t of e) if (!(t instanceof zs)) throw new Gn.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.", this);
        ...
        class Hs extends zs {
            ...
            _insertChild(t, e) {
                const n = function (t) {
                    ...
                    pi(t) || (t = [t]);
                    return Array.from(t).map(t => "string" == typeof t ? new Bs(t) : t instanceof Fs ? new Bs(t.data, t.getAttributes()) : t)
                }(e);
        ...
        class qs {
            constructor(t = {}) {
                ...
                if ("forward" != e && "backward" != e) throw new Gn.b("model-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.", t, {direction: e});
        ...
        class $s {
            constructor(t, e, n = "toNone") {
                ...
                if (!(e instanceof Array) || 0 === e.length) throw new Gn.b("model-position-path-incorrect-format: Position path must be an array with at least one item.", t, {path: e});
            ...
            get parent() {
                let t = this.root;
                for (let e = 0; e < this.path.length - 1; e++) if (!(t = t.getChild(t.offsetToIndex(this.path[e])))) throw new Gn.b("model-position-path-incorrect: The position's path is incorrect.", this, {position: this});
                if (t.is("text")) throw new Gn.b("model-position-path-incorrect: The position's path is incorrect.", this, {position: this});
                return t
            }
            ...
            static _createAt(t, e, n = "toNone") {
                if (t instanceof $s) return new $s(t.root, t.path, t.stickiness);
                {
                    ...
                    if (!i.is("element") && !i.is("documentFragment")) throw new Gn.b("model-position-parent-incorrect: Position parent have to be a element or document fragment.", [this, t]);
                    const o = i.getPath();
            ...
            static _createAfter(t, e) {
                if (!t.parent) throw new Gn.b("model-position-after-root: You cannot make a position after root.", [this, t], {root: t});
                return this._createAt(t.parent, t.endOffset, e)
            }

            static _createBefore(t, e) {
                if (!t.parent) throw new Gn.b("model-position-before-root: You cannot make a position before root.", t, {root: t});
            ...
            static fromJSON(t, e) {
                ...
                if (!e.getRoot(t.root)) throw new Gn.b("model-position-fromjson-no-root: Cannot create position for document. Root with specified name does not exist.", e, {rootName: t.root});
        ...
        class Zs {
            ...
            convertChanges(t, e, n) {
                ...
                for (const e of t.getChanges()) "insert" == e.type ? this.convertInsert(Gs._createFromPositionAndShift(e.position, e.length), n) : "remove" == e.type ? this.convertRemove(e.position, e.length, e.name, n) : this.convertAttribute(e.range, e.attributeKey, e.attributeOldValue, e.attributeNewValue, n);
        ...
        class ta {
            ...
            * getRanges() {
            ...
            setTo(t, e, n) {
                if (null === t) this._setRanges([]); else if (t instanceof ta) this._setRanges(t.getRanges(), t.isBackward); else if (t && "function" == typeof t.getRanges) this._setRanges(t.getRanges(), t.isBackward); else if (t instanceof Gs) this._setRanges([t], !!e && !!e.backward); else if (t instanceof $s) this._setRanges([new Gs(t)]); else if (t instanceof zs) {
                    const i = !!n && !!n.backward;
                    let o;
            ...
            _setRanges(t, e = !1) {
                const n = (t = Array.from(t)).some(e => {
                    if (!(e instanceof Gs)) throw new Gn.b("model-selection-set-ranges-not-range: Selection range set to an object that is not an instance of model.Range.", [this, t]);
            ...
            * getTopMostBlocks() {
            ...
            _checkRange(t) {
                for (let e = 0; e < this._ranges.length; e++) if (t.isIntersecting(this._ranges[e])) throw new Gn.b("model-selection-range-intersects: Trying to add a range that intersects with another range in the selection.", [this, t], {
                    addedRange: t,
        ...
        class aa extends ta {
            constructor(t) {
                super(), this.markers = new oo({idProperty: "name"}), this._model = t.model, this._document = t, this._attributePriority = new Map, this._fixGraveyardRangesData = [], this._hasChangedRange = !1, this._overriddenGravityRegister = new Set, this.listenTo(this._model, "applyOperation", (t, e) => {
                    ...
                    for (const t of this.getRanges()) if (!this._document._validateSelectionRange(t)) throw new Gn.b("document-selection-wrong-position: Range from document selection starts or ends at incorrect position.", this, {range: t})
            ...
            * getRanges() {
            ...
            restoreGravity(t) {
                if (!this._overriddenGravityRegister.has(t)) throw new Gn.b("document-selection-gravity-wrong-restore: Attempting to restore the selection gravity for an unknown UID.", this, {uid: t});
        ...
        class fa extends la {
            elementToElement(t) {
                return this.add(function (t) {
                    return (t = ua(t)).view = ga(t.view, "container"), e => {
            ...
            attributeToElement(t) {
                return this.add(function (t) {
                    ...
                    if (t.model.values) for (const e of t.model.values) t.view[e] = ga(t.view[e], "attribute"); else t.view = ga(t.view, "attribute");
                    const n = pa(t);
                    return i => {
                        i.on(e, function (t) {
                            return (e, n, i) => {
                    ...
                    return i => {
                        i.on(e, function (t) {
                            return (e, n, i) => {
                                ...
                                if (!s) throw new Gn.b("conversion-attribute-to-attribute-on-text: Trying to convert text node's attribute with attribute-to-attribute converter.", [n, i]);
            ...
            markerToElement(t) {
                return this.add(function (t) {
                    return (t = ua(t)).view = ga(t.view, "ui"), e => {
        ...
        function _a(t) {
            ...
            }(t = ua(t)), n = va(t), i = n ? "element:" + n : "element";
            return n => {
        ...
        class Ta {
            ...
            * [Symbol.iterator]() {
            ...
            init(t, e = []) {
                const n = this, i = this._editor, o = new Set, r = [], s = u(t), a = u(e), c = function (t) {
                    const e = [];
                ...
                if (c) {
                    ...
                    return console.error(Object(Gn.a)(t), {plugins: c}), Promise.reject(new Gn.b(t, this._editor, {plugins: c}))
                }
                ...
                function l(t) {
                    if (!a.includes(t) && !n._plugins.has(t) && !o.has(t)) return function (t) {
                        ...
                        throw console.error(Object(Gn.a)("plugincollection-load: It was not possible to load the plugin."), {plugin: t}), e
                    })
                }
            ...
            _add(t, e) {
                ...
                if (n) {
                    if (this._plugins.has(n)) throw new Gn.b("plugincollection-plugin-name-conflict: Two plugins with the same name were loaded.", null, {
                        pluginName: n,
        ...
        class Ca {
            ...
            execute(t, ...e) {
                const n = this.get(t);
                if (!n) throw new Gn.b("commandcollection-command-not-found: Command does not exist.", this, {commandName: t});
                n.execute(...e)
            }
        ...
        class Ma {
            constructor(t = {}) {
                this.uiLanguage = t.uiLanguage || "en", this.contentLanguage = t.contentLanguage || this.uiLanguage, this.uiLanguageDirection = Ea(this.uiLanguage), this.contentLanguageDirection = Ea(this.contentLanguage), this.t = ((...t) => this._t(...t))
            }
        ...
        class Ia {
            ...
            add(t, e) {
                let n;
                t.is("text") || t.is("documentFragment") ? this._consumables.set(t, !0) : (this._consumables.has(t) ? n = this._consumables.get(t) : (n = new Na, this._consumables.set(t, n)), n.add(e))
            }
        ...
        class Na {
            ...
            _add(t, e) {
                ...
                for (const e of n) {
                    if ("attributes" === t && ("class" === e || "style" === e)) throw new Gn.b("viewconsumable-invalid-attribute: Classes and styles should be handled separately.", this);
                    i.set(e, !0)
                }
            }
        ...
        class Oa {
            ...
            register(t, e) {
                if (this._sourceDefinitions[t]) throw new Gn.b("schema-cannot-register-item-twice: A single item cannot be registered twice in the schema.", this, {itemName: t});
                this._sourceDefinitions[t] = [Object.assign({}, e)], this._clearCache()
            }

            extend(t, e) {
                if (!this._sourceDefinitions[t]) throw new Gn.b("schema-cannot-extend-missing-item: Cannot extend an item which was not registered yet.", this, {itemName: t});
            ...
            checkMerge(t, e = null) {
                if (t instanceof $s) {
                    const e = t.nodeBefore, n = t.nodeAfter;
                    if (!(e instanceof Hs)) throw new Gn.b("schema-check-merge-no-element-before: The node before the merge position must be an element.", this);
                    if (!(n instanceof Hs)) throw new Gn.b("schema-check-merge-no-element-after: The node after the merge position must be an element.", this);
        ...
        class Ra {
            constructor(t) {
                ...
                "string" == typeof t ? t = [t] : Array.isArray(t) || (t = t.getAncestors({includeSelf: !0})), t[0] && "string" != typeof t[0] && t[0].is("documentFragment") && t.shift(), this._items = t.map(qa)
            }
        ...
        function Da(t, e) {
            ...
            }(t, n), Ua(t, n, "allowIn"), Ua(t, n, "allowContentOf"), Ua(t, n, "allowWhere"), Ua(t, n, "allowAttributes"), Ua(t, n, "allowAttributesOf"), Ua(t, n, "inheritTypesFrom"), function (t, e) {
                for (const n of t) {
        ...
        class Wa {
            ...
            convert(t, e, n = ["$root"]) {
                this.fire("viewCleanup", t), this._modelCursor = function (t, e) {
                    ...
                    return n
                }(n, e), this.conversionApi.writer = e, this.conversionApi.consumable = Ia.createFrom(t), this.conversionApi.store = {};
            ...
            _convertItem(t, e) {
                ...
                if (t.is("element") ? this.fire("element:" + t.name, n, this.conversionApi) : t.is("text") ? this.fire("text", n, this.conversionApi) : this.fire("documentFragment", n, this.conversionApi), n.modelRange && !(n.modelRange instanceof Gs)) throw new Gn.b("view-conversion-dispatcher-incorrect-result: Incorrect conversion result was dropped.", this);
        ...
        class Ya {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new Qs, this.downcastDispatcher = new Zs({mapper: this.mapper}), this.downcastDispatcher.on("insert:$text", (t, e, n) => {
                    ...
                    const i = n.writer, o = n.mapper.toViewPosition(e.range.start), r = i.createText(e.item.data);
                    i.insert(o, r)
                }, {priority: "lowest"}), this.upcastDispatcher = new Wa({schema: t.schema}), this.upcastDispatcher.on("text", (t, e, n) => {
            ...
            toView(t) {
                ...
                const e = Gs._createIn(t), n = new Ao, i = new To(new ro);
        ...
        class $a {
            ...
            elementToElement(t) {
                ...
                for (const {model: e, view: n} of Ga(t)) this.for("upcast").elementToElement({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {model: e, view: n} of Ga(t)) this.for("upcast").elementToAttribute({
                    view: n,
                    model: e,
                    converterPriority: t.converterPriority
                })
        ...
        function Xa(t, e) {
            const n = (e = nc(e)).reduce((t, e) => t + e.offsetSize, 0), i = t.parent;
            oc(t);
            const o = t.index;
        ...
        function nc(t) {
            ...
            for (let n = 0; n < t.length; n++) if ("string" == typeof t[n]) e.push(new Bs(t[n])); else if (t[n] instanceof Fs) e.push(new Bs(t[n].data, t[n].getAttributes())); else if (t[n] instanceof Za || t[n] instanceof Us) for (const i of t[n]) e.push(i); else t[n] instanceof zs && e.push(t[n]);
            for (let t = 1; t < e.length; t++) {
                const n = e[t], i = e[t - 1];
                n instanceof Bs && i instanceof Bs && rc(n, i) && (e.splice(t - 1, 2, new Bs(i.data + n.data, i.getAttributes())), t--)
            }
            return e
        }
        ...
        class ac extends Ja {
            ...
            _validate() {
                ...
                for (const t of this.range.getItems({shallow: !0})) {
                    if (null !== this.oldValue && !sc(t.getAttribute(this.key), this.oldValue)) throw new Gn.b("attribute-operation-wrong-old-value: Changed node has different attribute value than operation's old attribute value.", this, {
                        item: t,
                        key: this.key,
                        value: this.oldValue
                    });
                    if (null === this.oldValue && null !== this.newValue && t.hasAttribute(this.key)) throw new Gn.b("attribute-operation-attribute-exists: The attribute with given key already exists.", this, {
                        node: t,
                        key: this.key
                    })
                }
            ...
            _execute() {
                sc(this.oldValue, this.newValue) || function (t, e, n) {
                    oc(t.start), oc(t.end);
        ...
        class lc extends Ja {
            ...
            _validate() {
                ...
                if (this.sourcePosition.root == this.targetPosition.root && "prefix" == li(this.sourcePosition.getParentPath(), this.targetPosition.getParentPath())) {
                    ...
                    if (this.targetPosition.path[t] >= n && this.targetPosition.path[t] < n + this.howMany) throw new Gn.b("move-operation-node-into-itself: Trying to move a range of nodes into one of nodes from that range.", this)
                }
            }
        ...
        class dc extends Ja {
            constructor(t, e, n) {
                super(n), this.position = t.clone(), this.position.stickiness = "toNone", this.nodes = new Us(nc(e)), this.shouldReceiveAttributes = !1
            }
        ...
        class hc extends Ja {
            ...
            getReversed() {
                return new hc(this.name, this.newRange, this.oldRange, this._markers, this.affectsData, this.baseVersion + 1)
            }
            ...
            static fromJSON(t, e) {
                return new hc(t.name, t.oldRange ? Gs.fromJSON(t.oldRange, e) : null, t.newRange ? Gs.fromJSON(t.newRange, e) : null, e.model.markers, t.affectsData, t.baseVersion)
            }
        }
        ...
        class uc extends Ja {
            ...
            _validate() {
                ...
                if (!(t instanceof Hs)) throw new Gn.b("rename-operation-wrong-position: Given position is invalid or node after it is not an instance of Element.", this);
        ...
        class fc extends Ja {
            ...
            static fromJSON(t, e) {
                if (!e.getRoot(t.root)) throw new Gn.b("rootattribute-operation-fromjson-no-root: Cannot create RootAttributeOperation. Root with specified name does not exist.", this, {rootName: t.root});
        ...
        class mc extends Ja {
            ...
            _validate() {
                ...
                if (!t.parent) throw new Gn.b("merge-operation-source-position-invalid: Merge source position is invalid.", this);
                if (!e.parent) throw new Gn.b("merge-operation-target-position-invalid: Merge target position is invalid.", this);
        ...
        class gc extends Ja {
            constructor(t, e, n, i) {
                super(i), this.splitPosition = t.clone(), this.splitPosition.stickiness = "toNext", this.howMany = e, this.insertionPosition = gc.getInsertionPosition(t), this.insertionPosition.stickiness = "toNone", this.graveyardPosition = n ? n.clone() : null, this.graveyardPosition && (this.graveyardPosition.stickiness = "toNext")
            }
            ...
            _execute() {
                ...
                if (this.graveyardPosition) ec(Gs._createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition); else {
                    const e = t._clone();
                    Xa(this.insertionPosition, e)
                }
                ec(new Gs($s._createAt(t, this.splitPosition.offset), $s._createAt(t, t.maxOffset)), this.moveTargetPosition)
            }
        ...
        class bc {
            ...
            insert(t, e, n = 0) {
                ...
                const o = i.root.document ? i.root.document.version : null, r = new dc(i, t, o);
                if (t instanceof Bs && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), t instanceof Za) for (const [e, n] of t.markers) {
                    const t = $s._createAt(n.root, 0), o = {
            ...
            insertText(t, e, n, i) {
                e instanceof Za || e instanceof Hs || e instanceof $s ? this.insert(this.createText(t), e, n) : this.insert(this.createText(t, e), n, i)
            }

            insertElement(t, e, n, i) {
                e instanceof Za || e instanceof Hs || e instanceof $s ? this.insert(this.createElement(t), e, n) : this.insert(this.createElement(t, e), n, i)
            }
            ...
            appendText(t, e, n) {
                e instanceof Za || e instanceof Hs ? this.insert(this.createText(t), e, "end") : this.insert(this.createText(t, e), n, "end")
            }

            appendElement(t, e, n) {
                e instanceof Za || e instanceof Hs ? this.insert(this.createElement(t), e, "end") : this.insert(this.createElement(t, e), n, "end")
            }
            ...
            move(t, e, n) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof Gs)) throw new Gn.b("writer-move-invalid-range: Invalid range to move.", this);
                if (!t.isFlat) throw new Gn.b("writer-move-range-not-flat: Range to move is not flat.", this);
                const i = $s._createAt(e, n);
                if (i.isEqual(t.start)) return;
                if (this._addOperationForAffectedMarkers("move", t), !yc(t.root, i.root)) throw new Gn.b("writer-move-different-document: Range is going to be moved between different documents.", this);
            ...
            remove(t) {
                ...
                for (const t of e) this._addOperationForAffectedMarkers("move", t), vc(t.start, t.end.offset - t.start.offset, this.batch, this.model)
            }

            merge(t) {
                this._assertWriterUsedCorrectly();
                const e = t.nodeBefore, n = t.nodeAfter;
                if (this._addOperationForAffectedMarkers("merge", t), !(e instanceof Hs)) throw new Gn.b("writer-merge-no-element-before: Node before merge position must be an element.", this);
                if (!(n instanceof Hs)) throw new Gn.b("writer-merge-no-element-after: Node after merge position must be an element.", this);
            ...
            rename(t, e) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof Hs)) throw new Gn.b("writer-rename-not-element-instance: Trying to rename an object which is not an instance of Element.", this);
            ...
            split(t, e) {
                ...
                if (e || (e = o.parent), !t.parent.getAncestors({includeSelf: !0}).includes(e)) throw new Gn.b("writer-split-invalid-limit-element: Limit element is not a position ancestor.", this);
                do {
        ...
        function wc(t, e, n, i) {
            ...
            function d() {
                const i = new Gs(l, s), c = i.root.document ? r.version : null, d = new ac(i, e, a, n, c);
        ...
        function _c(t, e, n, i, o) {
            const r = t.model, s = r.document, a = new hc(e, n, i, r.markers, o, s.version);
            ...
            getChanges(t = {includeChangesInGraveyard: !1}) {
                ...
                for (const t of this._changesInElement.keys()) {
                    const n = this._changesInElement.get(t).sort((t, e) => t.offset === e.offset ? t.type != e.type ? "remove" == t.type ? -1 : 1 : 0 : t.offset < e.offset ? -1 : 1),
                        i = this._elementSnapshots.get(t), o = Ac(t.getChildren()), r = Tc(i.length, n);
                    let s = 0, a = 0;
        ...
        class Ic {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Pc(this), this.selection = new sa(this), this.roots = new oo({idProperty: "rootName"}), this.differ = new xc(t.markers), this._postFixers = new Set, this._hasSelectionChangedFromTheLastChangeBlock = !1, this.createRoot("$root", Ec), this.listenTo(t, "applyOperation", (t, e) => {
                    const n = e[0];
                    if (n.isDocumentOperation && n.baseVersion !== this.version) throw new Gn.b("model-document-applyOperation-wrong-version: Only operations with matching versions can be applied.", this, {operation: n})
            ...
            createRoot(t = "$root", e = "main") {
                if (this.roots.get(e)) throw new Gn.b("model-document-createRoot-name-exists: Root with specified name already exists.", this, {name: e});
        ...
        class Oc {
            ...
            _set(t, e, n = !1, i = !1) {
                const o = t instanceof Rc ? t.name : t, r = this._markers.get(o);
                if (r) {
                    const t = r.getRange();
                    let s = !1;
                ...
                const s = oa.fromRange(e), a = new Rc(o, s, n, i);
                return this._markers.set(o, a), this.fire("update:" + o, a, null, e), a
            }

            _remove(t) {
                const e = t instanceof Rc ? t.name : t, n = this._markers.get(e);
        ...
        class Dc extends $s {
            constructor(t, e, n = "toNone") {
                if (super(t, e, n), !this.root.is("rootElement")) throw new Gn.b("model-liveposition-root-not-rootelement: LivePosition's root has to be an instance of RootElement.", t);
                (function () {
                    this.listenTo(this.root.document.model, "applyOperation", (t, e) => {
                        const n = e[0];
                        n.isDocumentOperation && function (t) {
        ...
        class Lc {
            ...
            _insert(t) {
                if (!this.schema.checkChild(this.position, t)) throw new Gn.b("insertcontent-wrong-position: Given node cannot be inserted on the given position.", this, {
                    node: t,
            ...
            _setAffectedBoundaries(t) {
                this._affectedStart || (this._affectedStart = Dc.fromPosition(t, "toPrevious")), this._affectedEnd && !this._affectedEnd.isBefore(t) || (this._affectedEnd && this._affectedEnd.detach(), this._affectedEnd = Dc.fromPosition(t, "toNext"))
            }

            _mergeSiblingsOf(t, e) {
                if (!(t instanceof Hs)) return;
                const n = this._canMergeLeft(t, e), i = this._canMergeRight(t, e), o = Dc._createBefore(t);
                o.stickiness = "toNext";
                const r = Dc._createAfter(t);
                if (r.stickiness = "toNext", n) {
                    const t = Dc.fromPosition(this.position);
                    t.stickiness = "toNext", this._affectedStart.isEqual(o) && (this._affectedStart.detach(), this._affectedStart = Dc._createAt(o.nodeBefore, "end", "toPrevious")), this.writer.merge(o), o.isEqual(this._affectedEnd) && e.isLast && (this._affectedEnd.detach(), this._affectedEnd = Dc._createAt(o.nodeBefore, "end", "toNext")), this.position = t.toPosition(), t.detach()
                }
                if (i) {
                    ...
                    this._affectedEnd.isEqual(r) && (this._affectedEnd.detach(), this._affectedEnd = Dc._createAt(r.nodeBefore, "end", "toNext")), this.writer.merge(r), r.getShiftedBy(-1).isEqual(this._affectedStart) && e.isFirst && (this._affectedStart.detach(), this._affectedStart = Dc._createAt(r.nodeBefore, 0, "toPrevious")), this.position = t.toPosition(), t.detach()
                }
        ...
        function jc(t, e, n = {}) {
            ...
            t.change(t => {
                ...
                const r = i.start, s = Dc.fromPosition(i.end, "toNext");
                if (i.start.isTouching(i.end) || t.remove(i), n.leaveUnmerged || (!function t(e, n, i) {
                    ...
                    t(e, n, i)
                }(t, r, s), o.removeDisallowedAttributes(r.parent.getChildren(), t)), zc(t, e, r), function (t, e) {
        ...
        function Uc(t, e) {
            if ("text" == e.type) return "word" === t.unit ? function (t, e) {
                ...
                if (n) {
                    ...
                    for (; Sc(i, o) || "character" == e && Mc(i, o);) t.next(), o = t.position.offset - n.startOffset
                }
                return t.position
            ...
            return t.isCollapsed ? function (t, e) {
                ...
                if (c || l) {
                    const t = n.nodeAfter && i.nodeBefore && n.nodeAfter.parent === i.nodeBefore.parent,
                        o = c && (!t || !Qc(n.nodeAfter, e)), r = l && (!t || !Qc(i.nodeBefore, e));
                    let d = n, h = i;
        ...
        class Kc {
            constructor() {
                this.markers = new Oc, this.document = new Ic(this), this.schema = new Oa, this._pendingChanges = [], this._currentWriter = null, ["insertContent", "deleteContent", "modifySelection", "getSelectedContent", "applyOperation"].forEach(t => this.decorate(t)), this.on("applyOperation", (t, e) => {
                    e[0]._validate()
            ...
            enqueueChange(t, e) {
                "string" == typeof t ? t = new Ka(t) : "function" == typeof t && (e = t, t = new Ka), this._pendingChanges.push({
                    batch: t,
                    callback: e
        ...
        class il {
            constructor() {
                this._domParser = new DOMParser, this._domConverter = new rr({blockFiller: jo}), this._htmlWriter = new nl
            }
        ...
        class ol {
            ...
            * names() {
            ...
            add(t, e) {
                if (this.has(t)) throw new Gn.b("componentfactory-item-exists: The item already exists in the component factory.", this, {name: t});
                this._components.set(rl(t), {callback: e, originalName: t})
            }

            create(t) {
                if (!this.has(t)) throw new Gn.b("componentfactory-item-missing: The required component is not registered in the factory.", this, {name: t});
        ...
        class al {
            constructor(t) {
                this.editor = t, this.componentFactory = new ol(t), this.focusTracker = new sl, this._editableElementsMap = new Map, this.listenTo(t.editing.view.document, "layoutChanged", () => this.update())
            }
        ...
        function ll(t) {
            ...
            cl.has(r) || (cl.set(r, new Map), r.registerPostFixer(t => hl(r, t))), cl.get(r).set(n, {
                text: i,
                isDirectHost: o
            }), e.change(t => hl(r, t))
        }
        ...
        class ml extends al {
            constructor(t, e) {
                ...
                }(t.config.get("toolbar")), this._elementReplacer = new fl
            }
        ...
        class bl {
            ...
            * getViews() {
            ...
            static extend(t, e) {
                if (t._isRendered) throw new Gn.b("template-extend-render: Attempting to extend a template which has already been rendered.", [this, t]);
                !function t(e, n) {
            ...
            _renderText(t) {
                let e = t.node;
                return e ? t.revertData.text = e.textContent : e = t.node = document.createTextNode(""), vl(this.text) ? this._bindToObservable({
                    schema: this.text,
                    updater: function (t) {
                        return {
                            set(e) {
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes) if (i = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = i), o = B(n[0]) && n[0].ns ? n[0].ns : null, vl(n)) {
                    const a = o ? n[0].value : n;
                    s && Rl(e) && a.unshift(i), this._bindToObservable({schema: a, updater: xl(r, e, o), data: t})
                } else "style" == e && "string" != typeof n[0] ? this._renderStyleAttribute(n[0], t) : (s && i && Rl(e) && n.unshift(i), El(n = n.map(t => t && t.value || t).reduce((t, e) => t.concat(e), []).reduce(Sl, "")) || r.setAttributeNS(o, e, n))
            }
            ...
            _renderElementChildren(t) {
                ...
                let o = 0;
                for (const r of this.children) if (Ol(r)) {
                    if (!i) {
                        r.setParent(e);
                        for (const t of r) n.appendChild(t.element)
                    }
                } else if (Il(r)) i || (r.isRendered || r.render(), n.appendChild(r.element)); else if (Zo(r)) n.appendChild(r); else if (i) {
            ...
            _bindToObservable({schema: t, updater: e, data: n}) {
                ...
                yl(t, e, n);
                const o = t.filter(t => !El(t)).filter(t => t.observable).map(i => i.activateAttributeListener(t, e, n));
                i && i.bindings.push(o)
            }
        ...
        function Cl(t) {
            if ("string" == typeof t ? t = function (t) {
                ...
                const e = [];
                if (t.children) if (Ol(t.children)) e.push(t.children); else for (const n of t.children) Nl(n) || Il(n) || Zo(n) ? e.push(n) : e.push(new bl(n));
                t.children = e
            }
            return t
        }
        ...
        class Ll extends Dl {
            ...
            _renderBodyCollection() {
                const t = this.locale, e = this._bodyCollectionContainer = new bl({
                    tag: "div",
                    attributes: {
        ...
        class Vl extends Ll {
            ...
            _createVoiceLabel(t) {
                const e = this.t, n = new jl;
                return n.text = e("bn"), n.extendTemplate({
                    attributes: {
        ...
        class Hl extends Dl {
            constructor(t) {
                super(t);
                const e = this.bindTemplate;
                this.set("isActive", !1), this.set("isSticky", !1), this.set("limiterElement", null), this.set("limiterBottomOffset", 50), this.set("viewportTopOffset", 0), this.set("_marginLeft", null), this.set("_isStickyToTheLimiter", !1), this.set("_hasViewportTopOffset", !1), this.content = this.createCollection(), this._contentPanelPlaceholder = new bl({
                    tag: "div",
                    attributes: {
                ...
                }).render(), this._contentPanel = new bl({
                    tag: "div",
                    attributes: {
        ...
        class $l extends Dl {
            constructor(t) {
                ...
                this.set("ariaLabel", n("bl")), this.items = this.createCollection(), this.focusTracker = new sl, this.keystrokes = new Jc, this.set("isVertical", !1), this.set("class"), this._focusCycler = new ql({
            ...
            fillFromConfig(t, e) {
                t.map(t => {
                    "|" == t ? this.items.add(new Yl) : e.has(t) ? this.items.add(e.create(t)) : console.warn(Object(Gn.a)("toolbarview-item-unavailable: The requested toolbar item is unavailable."), {name: t})
                })
            }
        }
        ...
        class Ql extends Xc {
            constructor(t, e) {
                super(e), Wn(t) && (this.sourceElement = t), this.data.processor = new il, this.model.document.createRoot(), this.ui = new ml(this, new Gl(this.locale, this.editing.view)), function (t) {
        ...
        class td extends Kl {
            ...
            init() {
                ...
                this._htmlDataProcessor = new il, n.addObserver(Zl), this.listenTo(i, "clipboardInput", e => {
                    t.isReadOnly && e.stop()
                    ...
                    i.content.isEmpty || (i.dataTransfer.setData("text/html", this._htmlDataProcessor.toData(i.content)), i.dataTransfer.setData("text/plain", function t(e) {
                        ...
                        if (e.is("text") || e.is("textProxy")) n = e.data; else if (e.is("img") && e.hasAttribute("alt")) n = e.getAttribute("alt"); else {
                            ...
                            for (const o of e.getChildren()) {
                                const e = t(o);
                                i && (i.is("containerElement") || o.is("containerElement")) && (Xl.includes(i.name) || Xl.includes(o.name) ? n += "\n" : n += "\n\n"), n += e, i = o
                            }
                        }
                        return n
        ...
        class ed {
            ...
            forceDisabled(t) {
                this._disableStack.add(t), 1 == this._disableStack.size && (this.on("set:isEnabled", nd, {priority: "highest"}), this.isEnabled = !1)
            }

            clearForceDisabled(t) {
                this._disableStack.delete(t), 0 == this._disableStack.size && (this.off("set:isEnabled", nd), this.refresh())
            }
        ...
        class ad extends Kl {
            ...
            init() {
                ...
                e.addObserver(sd), t.commands.add("enter", new od(t)), this.listenTo(n, "enter", (n, i) => {
        ...
        class hd extends Kl {
            ...
            init() {
                ...
                }), i.addObserver(sd), t.commands.add("shiftEnter", new cd(t)), this.listenTo(o, "enter", (e, n) => {
        ...
        function md(t) {
            ...
            mo.isAndroid ? i.document.on("beforeinput", (t, e) => r(e), {priority: "lowest"}) : i.document.on("keydown", (t, e) => r(e), {priority: "lowest"}), i.document.on("compositionstart", function () {
        ...
        const gd = [wo("arrowUp"), wo("arrowRight"), wo("arrowDown"), wo("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
        ...
        class wd {
            ...
            _handleContainerChildrenMutations(t, e) {
                ...
                if (f === u) return;
                const m = Qo(f, u), {firstChangeAt: g, insertions: p, deletions: b} = _d(m);
                let w = null;
            ...
            _handleTextMutation(t, e) {
                ...
                if (i === n) return;
                const o = Qo(i, n), {firstChangeAt: r, insertions: s, deletions: a} = _d(o);
                let c = null;
                ...
                const l = this.editing.view.createPositionAt(t.node, r), d = this.editing.mapper.toModelPosition(l),
                    h = this.editor.model.createRange(d, d.getShiftedBy(a)), u = n.substr(r, s);
                this.editor.execute("input", {text: u, range: h, resultRange: c})
            }

            _handleTextNodeInsertion(t) {
                if ("children" != t.type) return;
                const e = pd(t), n = this.editing.view.createPositionAt(t.node, e.index),
        ...
        class vd extends Kl {
            ...
            init() {
                const t = this.editor, e = new fd(t, t.config.get("typing.undoStep") || 20);
        ...
        class xd extends ur {
            constructor(t) {
                ...
                function i(t, n, i) {
                    let o;
                    e.once("delete", t => o = t, {priority: Number.POSITIVE_INFINITY}), e.fire("delete", new Xr(e, n, i)), o && o.stop.called && t.stop()
                }
                ...
                }), mo.isAndroid && e.on("beforeinput", (e, n) => {
        ...
        class Ad extends Kl {
            ...
            init() {
                const t = this.editor, e = t.editing.view, n = e.document;
                if (e.addObserver(xd), t.commands.add("forwardDelete", new yd(t, "forward")), t.commands.add("delete", new yd(t, "backward")), this.listenTo(n, "delete", (n, i) => {
        ...
        function Id(t, e, n) {
            ...
            for (; a < t.length;) {
                ...
                const s = e[o], c = Ed(n, s, i.getContext(n, s, !0)), l = Ed(s, n, i.getContext(s, n, !1));
            ...
            return Od(t, s.nextBaseVersionB), Od(e, s.nextBaseVersionA), {
                operationsA: t,
                operationsB: e,
        ...
        function jd(t, e) {
            const n = [];
            for (let i = 0; i < t.length; i++) {
                const o = t[i], r = new lc(o.start, o.end.offset - o.start.offset, e, 0);
                n.push(r);
        ...
        Sd(ac, ac, (t, e, n) => {
            if (t.key === e.key) {
                ...
                return o && n.aIsStrong && i.push(new ac(o, e.key, e.newValue, t.newValue, 0)), 0 == i.length ? [new Cd(0)] : i
            }
            return [t]
        }), Sd(ac, dc, (t, e) => {
            if (t.range.start.hasSameParentAs(e.position) && t.range.containsPosition(e.position)) {
                const n = t.range._getTransformedByInsertion(e.position, e.howMany, !e.shouldReceiveAttributes).map(e => new ac(e, t.key, t.oldValue, t.newValue, t.baseVersion));
            ...
            return [t]
        }), Sd(mc, dc, (t, e) => (t.sourcePosition.hasSameParentAs(e.position) && (t.howMany += e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByInsertOperation(e), t.targetPosition = t.targetPosition._getTransformedByInsertOperation(e), [t])), Sd(mc, mc, (t, e, n) => {
            ...
            return null !== h && s && (h.start = h.start._getCombined(e.sourcePosition, e.getMovedRangeStart()), h.end = h.end._getCombined(e.sourcePosition, e.getMovedRangeStart()), 0 === l.length ? l.push(h) : 1 == l.length ? o.start.isBefore(i.start) || o.start.isEqual(i.start) ? l.unshift(h) : l.push(h) : l.splice(1, 0, h)), 0 === l.length ? [new Cd(t.baseVersion)] : jd(l, r)
        }), Sd(lc, gc, (t, e, n) => {
            ...
            if (e.deletionPosition.hasSameParentAs(t.sourcePosition) && i.containsPosition(e.sourcePosition)) if ("remove" != t.type || n.forceWeakRemove) {
                ...
                t.howMany > 1 && (n.push(new lc(t.sourcePosition, t.howMany - 1, t.targetPosition, 0)), i = i._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany - 1), o = o._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany - 1));
                const r = e.deletionPosition._getCombined(t.sourcePosition, t.targetPosition), s = new lc(i, 1, r, 0),
            ...
            return [t]
        }), Sd(gc, dc, (t, e) => (t.splitPosition.hasSameParentAs(e.position) && t.splitPosition.offset < e.position.offset && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByInsertOperation(e), t.insertionPosition = gc.getInsertionPosition(t.splitPosition), [t])), Sd(gc, mc, (t, e, n) => {
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
                ...
                const i = new $s(e.graveyardPosition.root, n),
                    o = gc.getInsertionPosition(new $s(e.graveyardPosition.root, n)), r = new gc(i, 0, null, 0);
                return r.insertionPosition = o, t.splitPosition = t.splitPosition._getTransformedByMergeOperation(e), t.insertionPosition = gc.getInsertionPosition(t.splitPosition), t.graveyardPosition = r.insertionPosition.clone(), t.graveyardPosition.stickiness = "toNext", [r, t]
            }
            return t.splitPosition.hasSameParentAs(e.deletionPosition) && !t.splitPosition.isAfter(e.deletionPosition) && t.howMany--, t.splitPosition.hasSameParentAs(e.targetPosition) && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByMergeOperation(e), t.insertionPosition = gc.getInsertionPosition(t.splitPosition), t.graveyardPosition && (t.graveyardPosition = t.graveyardPosition._getTransformedByMergeOperation(e)), [t]
        }), Sd(gc, lc, (t, e, n) => {
            const i = Gs._createFromPositionAndShift(e.sourcePosition, e.howMany);
            ...
            if (t.splitPosition.hasSameParentAs(e.sourcePosition) && i.containsPosition(t.splitPosition)) {
                ...
                return t.howMany -= n, t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany), t.splitPosition = e.sourcePosition.clone(), t.insertionPosition = gc.getInsertionPosition(t.splitPosition), [t]
            }
            return !t.splitPosition.isEqual(e.targetPosition) || "insertAtSource" != n.baRelation && "splitBefore" != n.abRelation ? (e.sourcePosition.isEqual(e.targetPosition) || (t.splitPosition.hasSameParentAs(e.sourcePosition) && t.splitPosition.offset <= e.sourcePosition.offset && (t.howMany -= e.howMany), t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany)), t.splitPosition.stickiness = "toNone", t.splitPosition = t.splitPosition._getTransformedByMoveOperation(e), t.splitPosition.stickiness = "toNext", t.graveyardPosition ? t.insertionPosition = t.insertionPosition._getTransformedByMoveOperation(e) : t.insertionPosition = gc.getInsertionPosition(t.splitPosition), [t]) : (t.howMany += e.howMany, t.splitPosition = t.splitPosition._getTransformedByDeletion(e.sourcePosition, e.howMany), t.insertionPosition = gc.getInsertionPosition(t.splitPosition), [t])
        }), Sd(gc, gc, (t, e, n) => {
            ...
            if (t.graveyardPosition && e.graveyardPosition && t.graveyardPosition.isEqual(e.graveyardPosition)) {
                ...
                if (o && !i || !(i && !o) && n.aIsStrong) {
                    const n = [];
                    return e.howMany && n.push(new lc(e.moveTargetPosition, e.howMany, e.splitPosition, 0)), t.howMany && n.push(new lc(t.splitPosition, t.howMany, t.moveTargetPosition, 0)), n
                }
                return [new Cd(0)]
            }
            ...
            return t.splitPosition.hasSameParentAs(e.splitPosition) && t.splitPosition.offset < e.splitPosition.offset && (t.howMany -= e.howMany), t.splitPosition = t.splitPosition._getTransformedBySplitOperation(e), t.insertionPosition = gc.getInsertionPosition(t.splitPosition), [t]
        });
        ...
        class Ud extends Kl {
            ...
            init() {
                const t = this.editor;
                this._undoCommand = new Bd(t), this._redoCommand = new Fd(t), t.commands.add("undo", this._undoCommand), t.commands.add("redo", this._redoCommand), this.listenTo(t.model, "applyOperation", (t, e) => {
                    const n = e[0];
        ...
        class Wd extends Dl {
            constructor(t) {
                super(t);
                const e = this.bindTemplate, n = Jn();
            ...
            _createLabelView(t) {
                const e = new Dl, n = this.bindTemplate;
            ...
            _getTooltipString(t, e, n) {
                return t ? "string" == typeof t ? t : (n && (n = function (t) {
                    return mo.isMac ? _o(t).map(t => po[t.toLowerCase()] || t).reduce((t, e) => t.slice(-1) in go ? t + e : t + "+" + e) : t
        ...
        class Gd extends Kl {
            init() {
                const t = this.editor, e = t.locale, n = t.t, i = "ltr" == e.uiLanguageDirection ? Yd : $d,
        ...
        class Zd extends Kl {
            ...
            createLoader(t) {
                if (!this.createUploadAdapter) return console.warn(Object(Gn.a)("filerepository-no-upload-adapter: Upload adapter is not defined.")), null;
            ...
            _updatePendingAction() {
                ...
                if (this.loaders.length) {
                    if (!this._pendingAction) {
                        const e = this.editor.t, n = t => `${e("aw")} ${parseInt(t)}%.`;
        ...
        class Xd {
            constructor(t, e) {
                this.id = Jn(), this._filePromiseWrapper = this._createFilePromiseWrapper(t), this._adapter = e(this), this._reader = new Jd, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e) => e ? t / e * 100 : 0), this.set("uploadResponse", null)
            }
        ...
        ci(Xd, Fi);
        const th = "ckCsrfToken", eh = 40, nh = "abcdefghijklmnopqrstuvwxyz0123456789";
        ...
        class ah {
            constructor(t, e, n) {
                ...
                e instanceof RegExp ? i = e : r = e, "string" == typeof n ? o = n : s = n, r = r || (t => {
                    ...
                    }(c).slice(0, i.focus.offset), d = r(l), h = ch(c, d.format, t.model), u = ch(c, d.remove, t.model);
                    h.length && u.length && t.model.enqueueChange(t => {
        ...
        class uh extends Kl {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: hh}), t.model.schema.setAttributeProperties(hh, {
                    isFormatting: !0,
                    copyOnEnter: !0
        ...
        var fh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.187 17H5.773c-.637 0-1.092-.138-1.364-.415-.273-.277-.409-.718-.409-1.323V4.738c0-.617.14-1.062.419-1.332.279-.27.73-.406 1.354-.406h4.68c.69 0 1.288.041 1.793.124.506.083.96.242 1.36.478.341.197.644.447.906.75a3.262 3.262 0 0 1 .808 2.162c0 1.401-.722 2.426-2.167 3.075C15.05 10.175 16 11.315 16 13.01a3.756 3.756 0 0 1-2.296 3.504 6.1 6.1 0 0 1-1.517.377c-.571.073-1.238.11-2 .11zm-.217-6.217H7v4.087h3.069c1.977 0 2.965-.69 2.965-2.072 0-.707-.256-1.22-.768-1.537-.512-.319-1.277-.478-2.296-.478zM7 5.13v3.619h2.606c.729 0 1.292-.067 1.69-.2a1.6 1.6 0 0 0 .91-.765c.165-.267.247-.566.247-.897 0-.707-.26-1.176-.778-1.409-.519-.232-1.31-.348-2.375-.348H7z"/></svg>';
        const mh = "bold";
        ...
        class gh extends Kl {
            init() {
                ...
                t.ui.componentFactory.add(mh, n => {
                    const i = t.commands.get(mh), o = new Wd(n);
                    return o.set({
                        label: e("d"),
                        icon: fh,
                        keystroke: "CTRL+B",
                        tooltip: !0,
                        isToggleable: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(mh)), o
                })
            }
        }
        ...
        class bh extends Kl {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: ph}), t.model.schema.setAttributeProperties(ph, {
                    isFormatting: !0,
                    copyOnEnter: !0
                }), t.conversion.attributeToElement({
                    model: ph,
                ...
                }), t.commands.add(ph, new dh(t, ph)), t.keystrokes.set("CTRL+I", ph)
            }
        }

        var wh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.586 14.633l.021.004c-.036.335.095.655.393.962.082.083.173.15.274.201h1.474a.6.6 0 1 1 0 1.2H5.304a.6.6 0 0 1 0-1.2h1.15c.474-.07.809-.182 1.005-.334.157-.122.291-.32.404-.597l2.416-9.55a1.053 1.053 0 0 0-.281-.823 1.12 1.12 0 0 0-.442-.296H8.15a.6.6 0 0 1 0-1.2h6.443a.6.6 0 1 1 0 1.2h-1.195c-.376.056-.65.155-.823.296-.215.175-.423.439-.623.79l-2.366 9.347z"/></svg>';
        const kh = "italic";
        ...
        class _h extends Kl {
            init() {
                ...
                t.ui.componentFactory.add(kh, n => {
                    const i = t.commands.get(kh), o = new Wd(n);
                    return o.set({
                        label: e("e"),
                        icon: wh,
                        keystroke: "CTRL+I",
                        tooltip: !0,
                        isToggleable: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(kh)), o
                })
            }
        }
        ...
        class Ch extends Kl {
            init() {
                ...
                t.commands.add("blockQuote", new yh(t)), e.register("blockQuote", {
                    allowWhere: "$block",
                    allowContentOf: "$root"
                }), e.addChildCheck((t, e) => {
        ...
        var Ph = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 10.423a6.5 6.5 0 0 1 6.056-6.408l.038.67C6.448 5.423 5.354 7.663 5.22 10H9c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574zm8 0a6.5 6.5 0 0 1 6.056-6.408l.038.67c-2.646.739-3.74 2.979-3.873 5.315H17c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574z"/></svg>';
        n(34);
        ...
        var Mh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.627 16.5zm5.873-.196zm0-7.001V8h-13v8.5h4.341c.191.54.457 1.044.785 1.5H2a1.5 1.5 0 0 1-1.5-1.5v-13A1.5 1.5 0 0 1 2 2h4.5a1.5 1.5 0 0 1 1.06.44L9.122 4H16a1.5 1.5 0 0 1 1.5 1.5v1A1.5 1.5 0 0 1 19 8v2.531a6.027 6.027 0 0 0-1.5-1.228zM16 6.5v-1H8.5l-2-2H2v13h1V8a1.5 1.5 0 0 1 1.5-1.5H16z"/><path d="M14.5 19.5a5 5 0 1 1 0-10 5 5 0 0 1 0 10zM15 14v-2h-1v2h-2v1h2v2h1v-2h2v-1h-2z"/></svg>';
        ...
        class Lh {
            constructor(t, e, n) {
                ...
                if (!n) throw new Gn.b("fileuploader-missing-api-address: Api address must be provided as the third argument.", null);
                this.file = function (t) {
                    ...
                    try {
                        const n = t.match(Dh)[1], i = atob(t.replace(Dh, "")), o = [];
            ...
            _sendRequest() {
                ...
                return t.append("file", this.file), new Promise((n, i) => {
                    e.addEventListener("load", () => {
                        ...
                        return t < 200 || t > 299 ? o.message ? i(new Gn.b("fileuploader-uploading-data-failed: Uploading file failed.", this, {message: o.message})) : i(o.error) : n(o)
        ...
        class Vh {
            constructor(t, e = jh) {
                if (!t) throw new Gn.b("token-missing-token-url: A `tokenUrl` must be provided as the first constructor argument.", this);
                this.set("value", e.initValue), this._refresh = "function" == typeof t ? t : () => (function (t) {
                    return new Promise((e, n) => {
                        ...
                        i.open("GET", t), i.addEventListener("load", () => {
                            ...
                            return t < 200 || t > 299 ? n(new Gn.b("token-cannot-download-new-token: Cannot download new token from the provided url.", null)) : e(o)
                        }), i.addEventListener("error", () => n(new Error("Network Error"))), i.addEventListener("abort", () => n(new Error("Abort"))), i.send()
                    })
                })(t), this._options = Object.assign({}, jh, e)
            }
        ...
        class Fh extends Kl {
            ...
            init() {
                const t = this.editor, e = t.plugins.get(Bh), n = e.token, i = e.uploadUrl;
                n && (this._uploadGateway = new Fh._UploadGateway(n, i), t.plugins.get(Zd).createUploadAdapter = (t => new Uh(this._uploadGateway, t)))
            }
        }
        ...
        ci(Wh, ei);
        var Qh = '<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M4 0v1H1v3H0V.5A.5.5 0 0 1 .5 0H4zm8 0h3.5a.5.5 0 0 1 .5.5V4h-1V1h-3V0zM4 16H.5a.5.5 0 0 1-.5-.5V12h1v3h3v1zm8 0v-1h3v-3h1v3.5a.5.5 0 0 1-.5.5H12z"/><path fill-opacity=".256" d="M1 1h14v14H1z"/><g class="ck-icon__selected-indicator"><path d="M7 0h2v1H7V0zM0 7h1v2H0V7zm15 0h1v2h-1V7zm-8 8h2v1H7v-1z"/><path fill-opacity=".254" d="M1 1h14v14H1z"/></g></svg>';
        const Kh = "ck-widget", Jh = "ck-widget_selected";
        ...
        function Xh(t, e, n = {}) {
            return mo.isEdge || e.setAttribute("contenteditable", "false", t), e.addClass(Kh, t), e.setCustomProperty("widget", !0, t), t.getFillerOffset = iu, n.label && function (t, e, n) {
        ...
        function su(t, e, n = {}) {
            const i = t.createElement("image", n), o = nu(e.document.selection, e);
        ...
        class lu extends Kl {
            init() {
                ...
                t.editing.view.addObserver(Hh), e.register("image", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    ...
                    model: "image", view: (t, e) => (function (t, e, n) {
                        return e.setCustomProperty("image", !0, t), Xh(t, e, {
                            label: function () {
                    ...
                    function t(t, e, n) {
                        ...
                        const o = n.convertItem(i, e.modelCursor), r = vh(o.modelRange.getItems());
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    for (const t of o.getRanges()) for (const e of t) {
                        const t = e.item;
                        Zh(t) && !mu(t, s) && (i.addClass(Jh, t), this._previouslySelected.add(t), s = t, t == r && i.setSelection(o.getRanges(), {
                            fake: !0,
                            label: tu(r)
                        }))
                    }
                }, {priority: "low"}), t.addObserver(hu), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {priority: "high"}), this.listenTo(e, "delete", (t, e) => {
        ...
        class gu extends ed {
            refresh() {
                ...
                this.isEnabled = ru(t), ru(t) && t.hasAttribute("alt") ? this.value = t.getAttribute("alt") : this.value = !1
            }
        ...
        class wu extends Dl {
            constructor(t, e) {
                super(t);
                const n = `ck-input-${Jn()}`, i = `ck-status-${Jn()}`;
            ...
            _createStatusView(t) {
                const e = new Dl(this.locale), n = this.bindTemplate;
                return e.setTemplate({
                    tag: "div",
                    attributes: {
        ...
        var vu = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.972 16.615a.997.997 0 0 1-.744-.292l-4.596-4.596a1 1 0 1 1 1.414-1.414l3.926 3.926 9.937-9.937a1 1 0 0 1 1.414 1.415L7.717 16.323a.997.997 0 0 1-.745.292z"/></svg>',
            yu = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.591 10.177l4.243 4.242a1 1 0 0 1-1.415 1.415l-4.242-4.243-4.243 4.243a1 1 0 0 1-1.414-1.415l4.243-4.242L4.52 5.934A1 1 0 0 1 5.934 4.52l4.243 4.243 4.242-4.243a1 1 0 1 1 1.415 1.414l-4.243 4.243z"/></svg>';
        n(42);
        ...
        class xu extends Dl {
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), _u({view: this}), [this.labeledInput, this.saveButtonView, this.cancelButtonView].forEach(t => {
            ...
            _createLabeledInputView() {
                const t = this.locale.t, e = new wu(this.locale, ku);
        ...
        n(44);
        const Pu = Fl("px"), Su = nr.document.body;
        ...
        class Mu extends Dl {
            ...
            attachTo(t) {
                this.show();
                const e = Mu.defaultPositions, n = Object.assign({}, {
                    ...
                    limiter: Su,
                    fitInViewport: !0
                }, t), i = Mu._getOptimalPosition(n), o = parseInt(i.left), r = parseInt(i.top), s = i.name;
            ...
            _startPinning(t) {
                this.attachTo(t);
                const e = Eu(t.target), n = t.limiter ? Eu(t.limiter) : Su;
        ...
        Mu.arrowHorizontalOffset = 25, Mu.arrowVerticalOffset = 10, Mu._getOptimalPosition = Au, Mu.defaultPositions = {
        ...
        var Ou = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.463 5.187a.888.888 0 1 1 1.254 1.255L9.16 10l3.557 3.557a.888.888 0 1 1-1.254 1.255L7.26 10.61a.888.888 0 0 1 .16-1.382l4.043-4.042z" /></svg>\n',
        ...
        class Lu extends Kl {
            ...
            _createRotatorView() {
                const t = new ju(this.editor.locale), e = this.editor.locale.t;
        ...
        class ju extends Dl {
            constructor(t) {
                ...
                this.set("isNavigationVisible", !0), this.focusTracker = new sl, this.buttonPrevView = this._createButtonView(e("bq"), Ou), this.buttonNextView = this._createButtonView(e("br"), Ru), this.content = this.createCollection(), this.setTemplate({
                    tag: "div",
        ...
        class Fu extends Kl {
            ...
            _createForm() {
                ...
                this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new xu(t.locale), this._form.render(), this.listenTo(this._form, "submit", () => {
                    ...
                    ou(e.selection) ? this._isVisible && function (t) {
        ...
        class qu extends Dl {
            constructor(t) {
                super(t), this.buttonView = new Wd(t), this._fileInputView = new Wu(t), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
                    tag: "span",
        ...
        var Yu = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.91 10.54c.26-.23.64-.21.88.03l3.36 3.14 2.23-2.06a.64.64 0 0 1 .87 0l2.52 2.97V4.5H3.2v10.12l3.71-4.08zm10.27-7.51c.6 0 1.09.47 1.09 1.05v11.84c0 .59-.49 1.06-1.09 1.06H2.79c-.6 0-1.09-.47-1.09-1.06V4.08c0-.58.49-1.05 1.1-1.05h14.38zm-5.22 5.56a1.96 1.96 0 1 1 3.4-1.96 1.96 1.96 0 0 1-3.4 1.96z"/></svg>';
        ...
        class Qu extends Kl {
            init() {
                ...
                t.ui.componentFactory.add("imageUpload", n => {
                    const i = new qu(n), o = t.commands.get("imageUpload");
        ...
        class Ju extends Kl {
            ...
            uploadStatusChange(t, e, n) {
                ...
                if (!n.consumable.consume(e.item, t.name)) return;
                const s = i.plugins.get(Zd), a = r ? e.attributeNewValue : null, c = this.placeholder,
                    l = i.editing.mapper.toViewElement(o), d = n.writer;
                if ("reading" == a) return Zu(l, d), void Xu(c, l, d);
                if ("uploading" == a) {
                    const t = s.loaders.get(r);
                    return Zu(l, d), void (t ? (tf(l, d), function (t, e, n, i) {
                        const o = function (t) {
        ...
        function Xu(t, e, n) {
            ...
            i.getAttribute("src") !== t && n.setAttribute("src", t, i), ef(e, "placeholder") || n.insert(n.createPositionAfter(i), function (t) {
        ...
        function tf(t, e) {
            t.hasClass("ck-image-upload-placeholder") && e.removeClass("ck-image-upload-placeholder", t), nf(t, e, "placeholder")
        }
        ...
        class rf extends ed {
            ...
            execute(t) {
                const e = this.editor, n = e.model, i = e.plugins.get(Zd);
                n.change(e => {
        ...
        class af extends Kl {
            ...
            init() {
                const t = this.editor, e = t.model.document, n = t.model.schema, i = t.conversion,
                    o = t.plugins.get(Zd);
                n.extend("image", {allowAttributes: ["uploadId", "uploadStatus"]}), t.commands.add("imageUpload", new rf(t)), i.for("upcast").attributeToAttribute({
                    view: {
                        name: "img",
                        key: "uploadId"
                    }, model: "uploadId"
            ...
            _readAndUpload(t, e) {
                const n = this.editor, i = n.model, o = n.locale.t, r = n.plugins.get(Zd), s = n.plugins.get(Ih);
        ...
        class df extends ed {
            refresh() {
                const t = this.editor.model, e = vh(t.document.selection.getSelectedBlocks());
        ...
        class uf extends Kl {
            ...
            init() {
                ...
                t.commands.add("paragraph", new df(t)), e.schema.register("paragraph", {inheritAllFrom: "$block"}), t.conversion.elementToElement({
                    model: "paragraph",
                    view: "p"
                }), t.conversion.for("upcast").elementToElement({
                    model: (t, e) => uf.paragraphLikeElements.has(t.name) ? t.isEmpty ? null : e.createElement("paragraph") : null,
                    converterPriority: "low"
                }), n.upcastDispatcher.on("element", (t, e, n) => {
                    n.consumable.test(e.viewItem, {name: e.viewItem.name}) && mf(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, ff(e.viewItem, e.modelCursor, n))
                }, {priority: "low"}), n.upcastDispatcher.on("text", (t, e, n) => {
                    e.modelRange || mf(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, ff(e.viewItem, e.modelCursor, n))
        ...
        uf.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td"]);
        ...
        class gf extends ed {
            ...
            refresh() {
                ...
                this.value = !!t && this.modelElements.includes(t.name) && t.name, this.isEnabled = !!t && this.modelElements.some(e => pf(t, e, this.editor.model.schema))
            }
        ...
        class wf extends Kl {
            ...
            init() {
                ...
                for (const i of e) i.model !== bf && (t.model.schema.register(i.model, {inheritAllFrom: "$block"}), t.conversion.elementToElement(i), n.push(i.model));
        ...
        class vf extends Dl {
            constructor(t, e, n) {
                ...
                this.buttonView = e, this.panelView = n, this.set("isOpen", !1), this.set("isEnabled", !0), this.set("class"), this.set("panelPosition", "auto"), this.focusTracker = new sl, this.keystrokes = new Jc, this.setTemplate({
                    tag: "div",
            ...
            render() {
                super.render(), this.listenTo(this.buttonView, "open", () => {
                    ...
                    this.isOpen && ("auto" === this.panelPosition ? this.panelView.position = vf._getOptimalPosition({
        ...
        var yf = '<svg viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg"><path d="M.941 4.523a.75.75 0 1 1 1.06-1.06l3.006 3.005 3.005-3.005a.75.75 0 1 1 1.06 1.06l-3.549 3.55a.75.75 0 0 1-1.168-.136L.941 4.523z"/></svg>';
        ...
        class Af extends Dl {
            constructor() {
                super(), this.items = this.createCollection(), this.focusTracker = new sl, this.keystrokes = new Jc, this._focusCycler = new ql({
                    focusables: this.items,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
        ...
        function Sf(t, e = xf) {
            const n = new e(t), i = new _f(t), o = new vf(t, n, i);
            return n.bind("isEnabled").to(o), n instanceof xf ? n.bind("isOn").to(o, "isOpen") : n.arrowView.bind("isOn").to(o, "isOpen"), function (t) {
                (function (t) {
                    t.on("render", () => {
                        bu({
        ...
        function Mf(t, e) {
            const n = t.locale, i = t.listView = new Af(n);
            i.items.bindTo(e).using(({type: t, model: e}) => {
                if ("separator" === t) return new Cf(n);
                if ("button" === t || "switchbutton" === t) {
                    const i = new Tf(n);
                    let o;
                    return (o = "button" === t ? new Wd(n) : new Pf(n)).bind(...Object.keys(e)).to(e), o.delegate("execute").to(i), i.children.add(o), i
                }
        ...
        class Ef extends Kl {
            init() {
                ...
                t.ui.componentFactory.add("heading", e => {
                    ...
                    const d = Sf(e);
                    return Mf(d, s), d.buttonView.set({
                        isOn: !1,
                        withText: !0,
                        tooltip: o
        ...
        class Of extends Kl {
            init() {
                ...
                i.downcastDispatcher.on("insert:caption", Rf(t => t.createContainerElement("figcaption"), !1));
                ...
                o.downcastDispatcher.on("insert:caption", Rf(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {priority: "high"}), o.downcastDispatcher.on("remove", this._fixCaptionVisibility(t => t.position.parent), {priority: "high"}), e.document.registerPostFixer(t => this._updateCaptionVisibility(t))
            }
            ...
            _updateCaptionVisibility(t) {
                ...
                if (s && (i = e.toViewElement(s)), i) return n ? n === i ? jf(i, t) : (Lf(n, t), this._lastSelectedCaption = i, jf(i, t)) : (this._lastSelectedCaption = i, jf(i, t));
                if (n) {
                    const e = Lf(n, t);
            ...
            _fixCaptionVisibility(t) {
                return (e, n, i) => {
                    const o = Df(t(n)), r = this.editor.editing.mapper, s = i.writer;
                    if (o) {
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const t of n) if ("insert" == t.type && "$text" != t.name) {
                    ...
                    if (n.is("image") && !If(n) && i.push(n), !n.is("image") && n.childCount) for (const t of e.createRangeIn(n).getItems()) t.is("image") && !If(t) && i.push(t)
                }
        ...
        class Vf extends ed {
            ...
            refresh() {
                const t = this.editor.model.document.selection.getSelectedElement();
                if (this.isEnabled = ru(t), t) if (t.hasAttribute("imageStyle")) {
        ...
        var Bf = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm2.5 3V12h11V7.5h-11zM4.061 6H15.94c.586 0 1.061.407 1.061.91v5.68c0 .503-.475.91-1.061.91H4.06c-.585 0-1.06-.407-1.06-.91V6.91C3 6.406 3.475 6 4.061 6zM2 16.5V15h16v1.5z"/></svg>',
            Ff = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M18 4.5V3H2v1.5h16zm0 3V6h-5.674v1.5H18zm0 3V9h-5.674v1.5H18zm0 3V12h-5.674v1.5H18zm-8.5-6V12h-6V7.5h6zm.818-1.5H2.682C2.305 6 2 6.407 2 6.91v5.68c0 .503.305.91.682.91h7.636c.377 0 .682-.407.682-.91V6.91c0-.503-.305-.91-.682-.91zM18 16.5V15H2v1.5h16z"/></svg>',
        ...
        const qf = {
            ...
            alignLeft: {name: "alignLeft", title: "Left aligned image", icon: Ff, className: "image-style-align-left"},
            alignCenter: {
                name: "alignCenter",
        ...
        function $f(t) {
            if ("string" == typeof t) {
                const e = t;
                qf[e] ? t = Object.assign({}, qf[e]) : (console.warn(Object(Gn.a)("image-style-not-found: There is no such image style of given name."), {name: e}), t = {name: e})
            } else if (qf[t.name]) {
                const e = qf[t.name], n = Object.assign({}, t);
        ...
        class Gf extends Kl {
            ...
            init() {
                ...
                const r = function (t) {
                    return (e, n, i) => {
                        if (!i.consumable.consume(n.item, e.name)) return;
                        const o = zf(n.attributeNewValue, t), r = zf(n.attributeOldValue, t),
                ...
                i.downcastDispatcher.on("attribute:imageStyle:image", r), n.downcastDispatcher.on("attribute:imageStyle:image", r), n.upcastDispatcher.on("element:figure", function (t) {
                    ...
                    return (t, n, i) => {
                        ...
                        const o = n.viewItem, r = vh(n.modelRange.getItems());
                ...
                }(o), {priority: "low"}), t.commands.add("imageStyle", new Vf(t, o))
            }
        }
        ...
        class Kf extends Kl {
            ...
            register(t, {ariaLabel: e, items: n, getRelatedElement: i, balloonClassName: o = "ck-toolbar-container"}) {
                const r = this.editor, s = r.t, a = new $l(r.locale);
                if (a.ariaLabel = e || s("av"), this._toolbarDefinitions.has(t)) throw new Gn.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", this, {toolbarId: t});
            ...
            _showToolbar(t, e) {
                this._isToolbarVisible(t) ? Jf(this.editor, e) : this._isToolbarInBalloon(t) || (this._balloon.add({
                    view: t.view,
        ...
        function Jf(t, e) {
            const n = t.plugins.get("ContextualBalloon"), i = Zf(t, e);
            n.updatePosition(i)
        }

        function Zf(t, e) {
            const n = t.editing.view, i = Mu.defaultPositions;
            return {
        ...
        var _m = function (t, e) {
            ...
            return o
        }, vm = 1 / 0, ym = o ? o.prototype : void 0, xm = ym ? ym.toString : void 0;
        var Am = function t(e) {
        ...
        var Cm = function (t) {
            return function (e) {
                e = Tm(e);
                var n = sm(e) ? km(e) : void 0, i = n ? n[0] : e.charAt(0), o = n ? om(n, 1).join("") : e.slice(1);
                return i[t]() + o
            }
        }("toUpperCase");
        const Pm = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
        ...
        n(73);
        const zm = "ck-link_selected", Bm = "automatic", Fm = "manual", Um = /^(https?:)?\/\//;
        ...
        class Hm extends Kl {
            ...
            init() {
                ...
                }), t.commands.add("link", new em(t)), t.commands.add("unlink", new nm(t));
                ...
                this._enableAutomaticDecorators(n.filter(t => t.mode === Bm)), this._enableManualDecorators(n.filter(t => t.mode === Fm)), function ({
                                                                                                                                                         view: t,
                                                                                                                                                         model: e,
                                                                                                                                                         emitter: n,
                                                                                                                                                         attribute: i,
                    ...
                    const r = new Om(e, n, i), s = e.document.selection;
            ...
            _enableManualDecorators(t) {
                ...
                t.forEach(t => {
                    e.model.schema.extend("$text", {allowAttributes: t.id}), n.add(new Nm(t)), e.conversion.for("downcast").attributeToElement({
                        model: t.id,
                        view: (e, i) => {
                            if (e) {
        ...
        class Wm extends Dl {
            constructor(t, e = []) {
                super(t);
                const n = t.t;
                this.focusTracker = new sl, this.keystrokes = new Jc, this.urlInputView = this._createUrlInput(), this.saveButtonView = this._createButton(n("bd"), vu, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(n("be"), yu, "ck-button-cancel", "cancel"), this._manualDecoratorSwitches = this._createManualDecoratorSwitches(e), this.children = this._createFormChildren(e), this._focusables = new gl, this._focusCycler = new ql({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {focusPrevious: "shift + tab", focusNext: "tab"}
            ...
            render() {
                super.render(), _u({view: this}), [this.urlInputView, ...this._manualDecoratorSwitches, this.saveButtonView, this.cancelButtonView].forEach(t => {
                    this._focusables.add(t), this.focusTracker.add(t.element)
                }), this.keystrokes.listenTo(this.element)
            }
        ...
        var Ym = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.077 15l.991-1.416a.75.75 0 1 1 1.229.86l-1.148 1.64a.748.748 0 0 1-.217.206 5.251 5.251 0 0 1-8.503-5.955.741.741 0 0 1 .12-.274l1.147-1.639a.75.75 0 1 1 1.228.86L4.933 10.7l.006.003a3.75 3.75 0 0 0 6.132 4.294l.006.004zm5.494-5.335a.748.748 0 0 1-.12.274l-1.147 1.639a.75.75 0 1 1-1.228-.86l.86-1.23a3.75 3.75 0 0 0-6.144-4.301l-.86 1.229a.75.75 0 0 1-1.229-.86l1.148-1.64a.748.748 0 0 1 .217-.206 5.251 5.251 0 0 1 8.503 5.955zm-4.563-2.532a.75.75 0 0 1 .184 1.045l-3.155 4.505a.75.75 0 1 1-1.229-.86l3.155-4.506a.75.75 0 0 1 1.045-.184zm4.919 10.562l-1.414 1.414a.75.75 0 1 1-1.06-1.06l1.414-1.415-1.415-1.414a.75.75 0 0 1 1.061-1.06l1.414 1.414 1.414-1.415a.75.75 0 0 1 1.061 1.061l-1.414 1.414 1.414 1.415a.75.75 0 0 1-1.06 1.06l-1.415-1.414z"/></svg>',
            $m = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7.3 17.37l-.061.088a1.518 1.518 0 0 1-.934.535l-4.178.663-.806-4.153a1.495 1.495 0 0 1 .187-1.058l.056-.086L8.77 2.639c.958-1.351 2.803-1.076 4.296-.03 1.497 1.047 2.387 2.693 1.433 4.055L7.3 17.37zM9.14 4.728l-5.545 8.346 3.277 2.294 5.544-8.346L9.14 4.728zM6.07 16.512l-3.276-2.295.53 2.73 2.746-.435zM9.994 3.506L13.271 5.8c.316-.452-.16-1.333-1.065-1.966-.905-.634-1.895-.78-2.212-.328zM8 18.5L9.375 17H19v1.5H8z"/></svg>';
        n(77);
        ...
        class Gm extends Dl {
            constructor(t) {
                super(t);
                const e = t.t;
                this.focusTracker = new sl, this.keystrokes = new Jc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("az"), Ym, "unlink"), this.editButtonView = this._createButton(e("ba"), $m, "edit"), this.set("href"), this._focusables = new gl, this._focusCycler = new ql({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {focusPrevious: "shift + tab", focusNext: "tab"}
            ...
            _createPreviewButton() {
                ...
                }), t.bind("label").to(this, "href", t => t || n("bc")), t.bind("isEnabled").to(this, "href", t => !!t), t.template.tag = "a", t.template.eventListeners = {}, t
            }
        }
        ...
        class Jm extends Kl {
            ...
            init() {
                const t = this.editor;
                t.editing.view.addObserver(qm), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = t.plugins.get(Lu), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
            }
            ...
            _createActionsView() {
                const t = this.editor, e = new Gm(t.locale), n = t.commands.get("link"), i = t.commands.get("unlink");
            ...
            _createFormView() {
                const t = this.editor, e = t.commands.get("link"), n = new Wm(t.locale, e.manualDecorators);
            ...
            _createToolbarLinkButton() {
                ...
                t.keystrokes.set(Km, (t, n) => {
                    ...
                    const i = new Wd(t);
                    return i.isEnabled = !0, i.label = n("aq"), i.icon = Qm, i.keystroke = Km, i.tooltip = !0, i.isToggleable = !0, i.bind("isEnabled").to(e, "isEnabled"), i.bind("isOn").to(e, "value", t => !!t), this.listenTo(i, "execute", () => this._showUI(!0)), i
                })
            }
            ...
            _getSelectedLinkElement() {
                ...
                {
                    const n = e.getFirstRange().getTrimmed(), i = Zm(n.start), o = Zm(n.end);
        ...
        class Xm extends ed {
            ...
            execute() {
                const t = this.editor.model, e = t.document,
                    n = Array.from(e.selection.getSelectedBlocks()).filter(e => eg(e, t.schema)), i = !0 === this.value;
                t.change(t => {
                    if (i) {
        ...
        function cg(t, e, n, i) {
            t.ui.componentFactory.add(e, o => {
                const r = t.commands.get(e), s = new Wd(o);
                return s.set({
                    label: n,
                    icon: i,
                    tooltip: !0,
            ...
            if (n.consumable.consume(e.viewItem, {name: !0})) {
                ...
                const a = function (t, e, n) {
                    ...
                    for (const s of e) if ("ul" == s.name || "ol" == s.name) r = n.convertItem(s, r).modelCursor; else {
                        ...
                        c && (t = e.modelCursor.parent.is("listItem") ? e.modelCursor.parent : _g(e.modelCursor), r = i.createPositionAfter(t))
                    }
                    return r
        ...
        function vg(t, e, n, i, o, r) {
            const s = ag(e.nodeBefore, {sameIndent: !0, smallerIndent: !0, listIndent: t, foo: "b"}), a = o.mapper,
            ...
            d = sg(d);
            for (const t of [...i.getChildren()]) (t.is("ul") || t.is("ol")) && (d = c.move(c.createRangeOn(t), d).end, rg(c, t, t.nextSibling), rg(c, t.previousSibling, t))
        }
        ...
        class yg extends Kl {
            ...
            init() {
                ...
                t.model.document.registerPostFixer(e => (function (t, e) {
                ...
                })(t.model, e)), n.mapper.registerViewToModelLength("li", xg), e.mapper.registerViewToModelLength("li", xg), n.mapper.on("modelToViewPosition", wg(n.view)), n.mapper.on("viewToModelPosition", function (t) {
                    return (e, n) => {
                    ...
                    return (e, n, i) => {
                        ...
                        r.remove(c), a && a.nextSibling && rg(r, a, a.nextSibling), vg(n.attributeOldValue + 1, n.range.start, c.start, o, i, t), og(n.item, o, i, t);
                    ...
                    return (e, n, i) => {
                        ...
                        a && a.nextSibling && rg(r, a, a.nextSibling), vg(i.mapper.toModelElement(o).getAttribute("listIndent") + 1, n.position, c.start, o, i, t);
                        for (const t of r.createRangeIn(l).getItems()) i.mapper.unbindViewElement(t);
                        e.stop()
                    }
                }(t.model)), n.downcastDispatcher.on("remove", mg, {priority: "low"}), e.upcastDispatcher.on("element:ul", pg, {priority: "high"}), e.upcastDispatcher.on("element:ol", pg, {priority: "high"}), e.upcastDispatcher.on("element:li", bg, {priority: "high"}), e.upcastDispatcher.on("element:li", gg), t.model.on("insertContent", kg, {priority: "high"}), t.commands.add("numberedList", new Xm(t, "numbered")), t.commands.add("bulletedList", new Xm(t, "bulleted")), t.commands.add("indentList", new ng(t, "forward")), t.commands.add("outdentList", new ng(t, "backward"));
        ...
        function xg(t) {
            let e = 1;
            for (const n of t.getChildren()) if ("ul" == n.name || "ol" == n.name) for (const t of n.getChildren()) e += xg(t);
            return e
        }

        var Ag = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM3.5 3v5H2V3.7H1v-1h2.5V3zM.343 17.857l2.59-3.257H2.92a.6.6 0 1 0-1.04 0H.302a2 2 0 1 1 3.995 0h-.001c-.048.405-.16.734-.333.988-.175.254-.59.692-1.244 1.312H4.3v1h-4l.043-.043zM7 14.75a.75.75 0 0 1 .75-.75h9.5a.75.75 0 1 1 0 1.5h-9.5a.75.75 0 0 1-.75-.75z"/></svg>',
            Tg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0C1 4.784 1.777 4 2.75 4c.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75C1.784 7.5 1 6.723 1 5.75zm6 9c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0c0-.966.777-1.75 1.75-1.75.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75-.966 0-1.75-.777-1.75-1.75z"/></svg>';
        ...
        class Ng extends ed {
            ...
            execute(t) {
                const e = this.editor.model, n = e.document.selection, i = Mg(n);
                if (i) e.change(e => {
            ...
            constructor(t, e) {
                const n = e.providers, i = e.extraProviders || [], o = new Set(e.removeProviders),
                    r = n.concat(i).filter(t => {
                        const e = t.name;
                        return e ? !o.has(e) : (console.warn(Object(Gn.a)("media-embed-no-provider-name: The configured media provider has no name and cannot be used."), {provider: t}), !1)
                    });
        ...
        class Lg {
            ...
            _getPlaceholderHtml() {
                ...
                return t.text = this._t("Open media in new tab"), e.content = Og, e.viewBox = Rg, new bl({
                    tag: "div",
        ...
        class jg extends Kl {
            ...
            init() {
                ...
                t.commands.add("mediaEmbed", new Ng(t)), e.register("media", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    allowAttributes: ["url"]
                ...
                }), i.for("dataDowncast").add(Pg(r, {renderMediaPreview: o})), i.for("editingDowncast").elementToElement({
                    model: "media",
                    view: (t, e) => {
                ...
                }), i.for("editingDowncast").add(Pg(r, {renderForEditingView: !0})), i.for("upcast").elementToElement({
                    view: {
                        name: "oembed",
                        attributes: {url: !0}
                    }, model: (t, e) => {
        ...
        class zg extends Kl {
            ...
            init() {
                ...
                this.listenTo(t.plugins.get(td), "inputTransformation", () => {
                    const t = e.selection.getFirstRange(), n = Dc.fromPosition(t.start);
            ...
            _embedMediaBetweenPositions(t, e) {
                const n = this.editor, i = n.plugins.get(jg).registry, o = new oa(t, e),
                ...
                n.commands.get("mediaEmbed").isEnabled && (this._positionToInsert = Dc.fromPosition(t), this._timeoutId = nr.window.setTimeout(() => {
                    n.model.change(t => {
                        let e;
                        this._timeoutId = null, t.remove(o), "$graveyard" !== this._positionToInsert.root.rootName && (e = this._positionToInsert), Eg(n.model, s, e), this._positionToInsert.detach(), this._positionToInsert = null
                    })
                }, 100))
            }
        }
        ...
        class Bg extends Dl {
            ...
            render() {
                super.render(), _u({view: this}), [this.urlInputView, this.saveButtonView, this.cancelButtonView].forEach(t => {
                    this._focusables.add(t), this.focusTracker.add(t.element)
                }), this.keystrokes.listenTo(this.element);
            ...
            _createUrlInput() {
                const t = this.locale.t, e = new wu(this.locale, ku), n = e.inputView;
                return this._urlInputViewInfoDefault = t("bg"), this._urlInputViewInfoTip = t("bh"), e.label = t("bi"), e.infoText = this._urlInputViewInfoDefault, n.placeholder = "https://example.com", n.on("input", () => {
        ...
        class Ug extends Kl {
            ...
            init() {
                const t = this.editor, e = t.commands.get("mediaEmbed"), n = t.plugins.get(jg).registry;
                this.form = new Bg(function (t, e) {
                    return [e => {
        ...
        function Hg(t, e) {
            ...
            i.forEach((t, r) => {
                if (!o || function (t, e) {
                    ...
                    o = function (t, e, n) {
                        const i = new ki(t.type), o = e.parent.getChildIndex(e);
                ...
                t.on("element:table", (t, e, n) => {
                    ...
                    if (l) {
                        if (n.writer.insert(c, l.position), n.consumable.consume(i, {name: !0}), o.length) o.forEach(t => n.convertItem(t, n.writer.createPositionAt(c, "end"))); else {
                            ...
                            n.writer.insert(t, n.writer.createPositionAt(c, "end")), ip(n.writer, n.writer.createPositionAt(t, "end"))
                        }
        ...
        function hp(t = {}) {
            return e => e.on("insert:table", (e, n, i) => {
                ...
                for (const e of l) {
                    const {row: n, cell: r} = e, s = yp(vp(n, d), a, i), c = o.getChild(n),
        ...
        function up(t = {}) {
            return e => e.on("insert:tableRow", (e, n, i) => {
                const o = n.item;
                if (!i.consumable.consume(o, "insert")) return;
                const r = o.parent, s = Cp(i.mapper.toViewElement(r)), a = r.getChildIndex(o),
                    c = new ap(r, {startRow: a, endRow: a}), l = {
                        headingRows: r.getAttribute("headingRows") || 0,
                        headingColumns: r.getAttribute("headingColumns") || 0
                    }, d = new Map;
                for (const e of c) {
                    const n = yp(vp(a, l), s, i), r = d.get(a) || kp(o, a, n, i);
                    d.set(a, r), i.consumable.consume(e.cell, "insert"), wp(e, l, i.writer.createPositionAt(r, "end"), i, t)
                }
            })
        }
        ...
        function fp(t = {}) {
            return e => e.on("insert:tableCell", (e, n, i) => {
                const o = n.item;
                if (!i.consumable.consume(o, "insert")) return;
                const r = o.parent, s = r.parent, a = s.getChildIndex(r), c = new ap(s, {startRow: a, endRow: a}), l = {
        ...
        function mp(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, i) => {
                ...
                const r = Cp(i.mapper.toViewElement(o)), s = n.attributeOldValue, a = n.attributeNewValue;
                if (a > s) {
                    ...
                    Tp(Array.from(o.getChildren()).filter(({index: t}) => c(t, a - 1, s)).reverse(), yp("tbody", r, i), i, 0);
                    const t = new ap(o, {startRow: a ? a - 1 : a, endRow: s - 1}), n = {
                        headingRows: o.getAttribute("headingRows") || 0,
                        headingColumns: o.getAttribute("headingColumns") || 0
                    };
        ...
        function pp(t, e, n, i) {
            ...
            let s;
            if (i) {
                s = eu(o.createEditableElement(e, r.getAttributes()), o), o.insert(o.createPositionAfter(r), s), o.move(o.createRangeIn(r), o.createPositionAt(s, 0)), o.remove(o.createRangeOn(r))
            } else s = o.rename(e, r);
            n.mapper.unbindViewElement(r), n.mapper.bindElements(t, s)
        }

        function bp(t, e, n, i) {
            const {cell: o} = t, r = _p(t, e), s = n.mapper.toViewElement(o);
            s && s.name !== r && pp(o, r, n, i)
        }

        function wp(t, e, n, i, o) {
            const r = o && o.asWidget, s = _p(t, e),
        ...
        class Pp extends ed {
            ...
            execute(t = {}) {
                const e = this.editor.model, n = e.document.selection, i = this.editor.plugins.get("TableUtils"),
                    o = parseInt(t.rows) || 2, r = parseInt(t.columns) || 2, s = nu(n, e);
                e.change(t => {
        ...
        class Sp extends ed {
            ...
            execute() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get("TableUtils"),
                    i = ep("tableCell", e.getFirstPosition()).parent, o = i.parent, r = o.getChildIndex(i),
        ...
        class Mp extends ed {
            ...
            execute() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get("TableUtils"),
                    i = ep("tableCell", e.getFirstPosition()), o = i.parent.parent, {column: r} = n.getCellLocation(i),
        ...
        class Ip extends ed {
            ...
            execute() {
                const t = this.editor.model, e = ep("tableCell", t.document.selection.getFirstPosition()),
                    n = this.value, i = this.direction;
                t.change(t => {
                    const o = "right" == i || "down" == i, r = o ? e : n, s = o ? n : e, a = s.parent;
                    !function (t, e, n) {
                        Np(t) || (Np(e) && n.remove(n.createRangeIn(e)), n.move(n.createRangeIn(t), n.createPositionAt(e, "end")));
                        n.remove(t)
                    }(s, r, t);
            ...
            _getMergeableCell() {
                ...
                const e = this.editor.plugins.get("TableUtils"), n = this.isHorizontal ? function (t, e, n) {
                    ...
                    const a = parseInt(t.getAttribute("rowspan") || 1), c = "down" == e ? o + a : o,
                        l = [...new ap(i, {endRow: c})], d = l.find(e => e.cell === t).column, h = l.find(({
                                                                                                               row: t,
                                                                                                               rowspan: n,
                                                                                                               column: i
        ...
        class Op extends ed {
            ...
            execute() {
                const t = this.editor.model, e = ep("tableCell", t.document.selection.getFirstPosition()).parent,
                    n = e.parent, i = n.getChildIndex(e), o = n.getAttribute("headingRows") || 0;
                t.change(t => {
                    o && i <= o && np("headingRows", o - 1, n, t, 0);
                    const r = [...new ap(n, {endRow: i})], s = new Map;
                    r.filter(({row: t, rowspan: e}) => t === i && e > 1).forEach(({
                                                                                      column: t,
                                                                                      cell: e,
                                                                                      rowspan: n
                                                                                  }) => s.set(t, {
                        cell: e,
                        rowspanToSet: n - 1
                    })), r.filter(({row: t, rowspan: e}) => t <= i - 1 && t + e > i).forEach(({
                                                                                                  cell: e,
                                                                                                  rowspan: n
                                                                                              }) => np("rowspan", n - 1, e, t));
                    const a = i + 1, c = new ap(n, {includeSpanned: !0, startRow: a, endRow: a});
                    let l;
        ...
        class Rp extends ed {
            ...
            execute() {
                const t = this.editor.model, e = ep("tableCell", t.document.selection.getFirstPosition()), n = e.parent,
                    i = n.parent, o = i.getAttribute("headingColumns") || 0, r = i.getChildIndex(n), s = [...new ap(i)],
                ...
                t.change(t => {
                    ...
                    for (const {
                        ...
                        column: n,
                        colspan: i
                    } of s) n <= a && i > 1 && n + i > a ? np("colspan", i - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        ...
        class Dp extends ed {
            refresh() {
                const t = ep("tableCell", this.editor.model.document.selection.getFirstPosition()), e = !!t;
                this.isEnabled = e, this.value = e && this._isInHeading(t, t.parent.parent)
            }

            execute(t = {}) {
                const e = this.editor.model, n = ep("tableCell", e.document.selection.getFirstPosition()).parent,
                ...
                e.change(t => {
                    if (s) {
                        const e = function (t, e, n) {
                            const i = [], o = new ap(t, {startRow: e > n ? n : 0, endRow: e - 1});
        ...
        function Lp(t, e, n) {
            ...
            c > 1 && (s.colspan = c);
            const l = o.getChildIndex(i), d = l + r, h = [...new ap(o, {startRow: l, endRow: d, includeSpanned: !0})];
            let u;
            for (const {
                row: e,
                column: i,
                cell: r,
                cellIndex: a
            } of h) if (r === t && void 0 === u && (u = i), void 0 !== u && u === i && e === d) {
        ...
        class jp extends ed {
            ...
            execute(t = {}) {
                const e = this.editor.model, n = e.document.selection, i = this.editor.plugins.get("TableUtils"),
                    o = ep("tableCell", n.getFirstPosition()), r = o.parent.parent, {column: s} = i.getCellLocation(o);
                if (t.forceValue === this.value) return;
        ...
        class Vp extends Kl {
            ...
            getCellLocation(t) {
                const e = t.parent, n = e.parent, i = n.getChildIndex(e), o = new ap(n, {startRow: i, endRow: i});
            ...
            insertRows(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (n > i && e.setAttribute("headingRows", n + o, t), 0 === i || i === t.childCount) return void zp(e, t, i, o, this.getColumns(t));
            ...
            splitCellVertically(t, e = 2) {
                ...
                n.change(n => {
                    if (r > 1) {
                        ...
                        np("colspan", s, t, n);
                        const a = {};
                        i > 1 && (a.colspan = i), o > 1 && (a.rowspan = o), Bp(r > e ? e - 1 : r - 1, n, n.createPositionAfter(t), a)
                    }
                    if (r < e) {
                        const s = e - r, a = [...new ap(i)], {column: c} = a.find(({cell: e}) => e === t),
            ...
            splitCellHorizontally(t, e = 2) {
                ...
                n.change(n => {
                    if (s > 1) {
                        ...
                        np("rowspan", l, t, n);
                        const {column: d} = i.find(({cell: e}) => e === t), h = {};
                    ...
                    if (s < e) {
                        const i = e - s, c = [...new ap(o, {startRow: 0, endRow: r})];
        ...
        function Up(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                ...
                for (const e of n) {
                    let n;
                    "table" == e.name && "insert" == e.type && (n = e.position.nodeAfter), "tableRow" != e.name && "tableCell" != e.name || (n = ep("table", e.position)), Wp(e) && (n = ep("table", e.range.start)), n && !o.has(n) && (i = Hp(n, t) || i, i = qp(n, t) || i, o.add(n))
                }
                return i
            })(e, t))
        }
        ...
        function Yp(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                const n = e.document.differ.getChanges();
                let i = !1;
                for (const e of n) "insert" == e.type && "table" == e.name && (i = $p(e.position.nodeAfter, t) || i), "insert" == e.type && "tableRow" == e.name && (i = Gp(e.position.nodeAfter, t) || i), "insert" == e.type && "tableCell" == e.name && (i = Qp(e.position.nodeAfter, t) || i), Kp(e) && (i = Qp(e.position.parent, t) || i);
                return i
            })(e, t))
        }
        ...
        class Xp extends Kl {
            init() {
                ...
                }), i.for("upcast").add(op()), i.for("editingDowncast").add(hp({asWidget: !0})), i.for("dataDowncast").add(hp()), i.for("upcast").elementToElement({
                    model: "tableRow",
                    view: "tr"
                }), i.for("editingDowncast").add(up({asWidget: !0})), i.for("dataDowncast").add(up()), i.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
        ...
        var nb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 6v3h4V6H3zm0 4v3h4v-3H3zm0 4v3h4v-3H3zm5 3h4v-3H8v3zm5 0h4v-3h-4v3zm4-4v-3h-4v3h4zm0-4V6h-4v3h4zm1.5 8a1.5 1.5 0 0 1-1.5 1.5H3A1.5 1.5 0 0 1 1.5 17V4c.222-.863 1.068-1.5 2-1.5h13c.932 0 1.778.637 2 1.5v13zM12 13v-3H8v3h4zm0-4V6H8v3h4z"/></svg>',
            ...
            ob = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M7 2h1v16H7V2zm5 0h1v16h-1V2z" opacity=".6"/><path d="M1 6h18a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zm1 2v4h4V8H2zm6 0v4h4V8H8zm6 0v4h4V8h-4z"/></svg>',
            rb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M7 2h1v16H7V2zm5 0h1v7h-1V2zm6 5v1H2V7h16zM8 12v1H2v-1h6z" opacity=".6"/><path d="M7 7h12a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1zm1 2v9h10V9H8z"/></svg>';

        class sb extends Kl {
            init() {
                const t = this.editor, e = this.editor.t;
                t.ui.componentFactory.add("insertTable", n => {
                    const i = t.commands.get("insertTable"), o = Sf(n);
                    ...
                    const n = [{
                        ...
                        type: "button",
                        model: {commandName: "insertTableColumnLeft", label: e("u")}
            ...
            _prepareDropdown(t, e, n, i) {
                const o = this.editor, r = Sf(i), s = [], a = new oo;
                for (const t of n) ab(t, o, s, a);
                return Mf(r, a), r.buttonView.set({
                    label: t,
                    icon: e,
                    tooltip: !0
        ...
        function ab(t, e, n, i) {
            const o = t.model = new kf(t.model), {commandName: r, bindIsOn: s} = t.model;
            if ("separator" !== t.type) {
        ...
        cb.builtinPlugins = [class extends Kl {
            static get requires() {
            ...
            _addBasicStylesAutoformats() {
                ...
                if (t.get("italic")) {
                    ...
                    new ah(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, t), new ah(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, t)
                }
                if (t.get("code")) {
            ...
            init() {
                ...
                e.push(new tp), e.push(new $g), t.plugins.get("Clipboard").on("inputTransformation", (t, n) => {
            ...
            afterInit() {
                const t = this.editor, e = t.t, n = t.plugins.get(Kf), i = t.config.get("table.contentToolbar"),
                    o = t.config.get("table.tableToolbar");
                i && n.register("tableContent", {
                    ariaLabel: e("c"),
                    items: i,
                    getRelatedElement: dp
