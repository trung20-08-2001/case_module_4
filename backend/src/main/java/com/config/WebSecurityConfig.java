...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/login/**", "/register/**","/user/**","/chat","/chat/getAllAccountByRending/{id}","/categories","/chat/getAllMessage/{idReceiving}/{idSending}").permitAll()
                .and().authorizeRequests().antMatchers("/admin","/admin/findShopAccount","admin/findUserAccount"
                        ...
                        ,"/categories/","/categories/addCategory","/admin/revenues","/admin/revenues/revenueByMonthYear/{month}/{year}"
